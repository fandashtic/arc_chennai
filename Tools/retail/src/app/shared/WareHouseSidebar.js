      ...
      <nav className="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul className="nav">
                ...
                <Dropdown.Toggle className="nav-link user-switch-dropdown-toggler p-0 toggle-arrow-hide bg-transparent border-0 w-100">
                  <div className="d-flex justify-content-between align-items-start">
                    ...
                    <div className="text-left ml-3">
                      <p className="profile-name">Manickam</p>
                      <small className="designation text-muted text-small">CEO</small>
          ...
          <li className={ this.isPathActive('/WareHouse/dashboard') ? 'nav-item active' : 'nav-item' }>
            <Link className="nav-link" to="/WareHouse/dashboard">
              <i className="mdi mdi-television menu-icon"></i>
              <span className="menu-title">Ware House</span>
            </Link>
          </li>
          <li className={ this.isPathActive('/basic-ui') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.basicUiMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/buttons') ? 'nav-link active' : 'nav-link' } to="/basic-ui/buttons">Edit Delivery</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/dropdowns') ? 'nav-link active' : 'nav-link' } to="/basic-ui/dropdowns">Cancel Delivery</Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/basic-ui/typography') ? 'nav-link active' : 'nav-link' } to="/basic-ui/typography">Close Delivery</Link></li>
              </ul>
            </Collapse>
          </li>
...
export default withRouter(WareHouseSidebar);