--exec SP_ARC_CancelSaleInvoices '2020-03-15 00:00:00','2020-05-15 23:59:59','%','Base UOM'
Exec ARC_Insert_ReportData 395, 'Canceled Sale Invoices', 1, 'SP_ARC_CancelSaleInvoices', 'Click to view Canceled Sale Invoices', 561, 577,1,2,0,1305,200,0,0,0,170, 'No'
GO
--Exec ARC_GetUnusedReportId
IF EXISTS(SELECT * FROM sys.objects WHERE Name = N'SP_ARC_CancelSaleInvoices')
BEGIN
    DROP PROC SP_ARC_CancelSaleInvoices
END
GO
CREATE PROCEDURE SP_ARC_CancelSaleInvoices(@Fromdate datetime,@Todate datetime,@SalesMan Nvarchar(4000),@UOM Nvarchar(255))  
AS  
Begin  
 Set DateFormat DMY  
 ...
 CREATE TABLE #Temp(  
  ...
  [Customer Category] Nvarchar(150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
  [Customer Group] Nvarchar(150) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
