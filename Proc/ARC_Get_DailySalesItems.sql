--exec ARC_Get_DailySalesItems '2020-03-15 00:00:00','2020-03-16 23:59:59'
--Exec ARC_Insert_ReportData 588, 'Daily Sales Items', 1, 'ARC_Get_DailySalesItems', 'Click to view Daily Sales Items', 561, 1,1,2,0,0,200,0,0,0,170, 'No'
GO
--Exec ARC_GetUnusedReportId
IF EXISTS(SELECT * FROM sys.objects WHERE Name = N'ARC_Get_DailySalesItems')
BEGIN
    DROP PROC [ARC_Get_DailySalesItems]
END
GO
CREATE procedure [dbo].[ARC_Get_DailySalesItems] (@FromDATE DATETIME,@ToDATE DATETIME)
As
Begin
	Set DateFormat DMY
