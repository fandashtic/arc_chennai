--Exec ARC_Get_CustomerHistory 'S.M.K.KRISHNA STORE(PML) -B'
IF EXISTS(SELECT * FROM sys.objects WHERE Name = N'ARC_Get_CustomerHistory')
BEGIN
    DROP PROC [ARC_Get_CustomerHistory]
END
GO
CREATE Proc ARC_Get_CustomerHistory(@CustomerName Nvarchar(255))
AS BEGIN
