Create PROCEDURE sp_print_InvAbstractSR_ITC_Template(@INVNO INT)          
AS   
/*       
...
--For ExciseDuty  
"Excise Duty" = InvoiceAbstract.ExciseDuty,"Customer Points" =Isnull(CustomerPoints,0),
"SR Sales Tax" = @SRTotalTax,
"SR Tax Suffered" = @SRTaxSuffered,"TaxComponent" = NULL,"AdjustmentComponent" = NULL,
"DeliveryDate" = DeliveryDate,
"CurrentInvoicePoints" = IsNull((Select Sum(IsNull(Points, 0)) from tbl_mERP_OutletPoints op
Where op.InvoiceID = InvoiceAbstract.InvoiceID And op.Status = 0 And op.QPS = 0), 0)
--,
