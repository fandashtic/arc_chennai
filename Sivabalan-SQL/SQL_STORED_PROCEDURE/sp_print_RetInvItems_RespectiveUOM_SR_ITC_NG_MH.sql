Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_MH](@INVNO INT,@MODE INT = 0)
AS
Begin
...
InvoiceDetail.UOM, Items.Soldas, #Temp1.SRQty,InvoiceDetail.Batch_Number,Batch_Products.PKD,Batch_Products.Expiry 
Order By #Temp1.SRQty desc, Min(InvoiceDetail.Serial)
...
--Select * From #TmpInvDet Order By Id1
