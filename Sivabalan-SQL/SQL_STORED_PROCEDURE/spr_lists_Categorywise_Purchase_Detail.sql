CREATE Procedure spr_lists_Categorywise_Purchase_Detail
                                                      (@BillID Int,
...
Select bd.Product_Code, 
  ...
  "Reporting UOM" = dbo.sp_Get_ReportingQty (Sum(bd.Quantity), i.ReportingUnit),
--  "Reporting UOM" = Sum(bd.Quantity) / (Case IsNull(i.ReportingUnit, 0) When 0 Then 1 Else i.ReportingUnit End),
