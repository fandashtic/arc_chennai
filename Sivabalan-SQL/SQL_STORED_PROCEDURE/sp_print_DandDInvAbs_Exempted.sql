Create Procedure [dbo].[sp_print_DandDInvAbs_Exempted](@DnDID INT)
AS
Set dateformat DMY
...
exec sp_print_DandDInvItems_RespectiveUOM @DnDID,1
...
Inner Join StateCode FromState On Inv.FromStateCode  = FromState.StateID
