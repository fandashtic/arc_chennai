CREATE procedure sp_acc_apvdetail(@apvid integer)  
as  
...
'APVDetail AccountID'= AccountID,Amount,Particular,DocumentReference,DocSerialType,Status,CancellationRemarks
