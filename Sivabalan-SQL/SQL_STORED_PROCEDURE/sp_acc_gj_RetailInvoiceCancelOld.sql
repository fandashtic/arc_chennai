CREATE Procedure sp_acc_gj_RetailInvoiceCancelOld(@INVOICEID INT,@BackDate DATETIME=Null)        
AS -- Journal entry for Retail Invoice cancel        
...
If @NetValue > 0        
Begin        
--Retail Invoice Cancellation        
 If @NetValue<>0        
 Begin        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@NetValue,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
 If @TotalSalesTax<>0        
 Begin        
  -- Entry for Sales Tax Account        
  execute sp_acc_insertGJ @TransactionID,@AccountID2,@InvoiceDate,@TotalSalesTax,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)        
 End        
 If @TotalTaxSuffered<>0        
 Begin        
  -- Entry for Sales Tax Account        
  execute sp_acc_insertGJ @TransactionID,@AccountID5,@InvoiceDate,@TotalTaxSuffered,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
 ...
 Begin
 	...
 	begin  
		...
		execute sp_acc_insertGJ @TransactionID,@VAT_Payable,@InvoiceDate,@nVatTaxamount,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
 ...
 Begin        
  ...
  execute sp_acc_insertGJ @TransactionID,@AccountID3,@InvoiceDate,@SalesValue,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
...
-----------------------------------------------------------------------------------------------        
 ...
 Begin        
  ...
  Commit Tran        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@RoundOffAmount,0,@InvoiceID,@AccountType,"Retail Invoice Cancel-RoundOff Amount",@DocumentNumber        
  -- Entry for RoundOff Account        
  execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,0,@RoundOffAmount,@InvoiceID,@AccountType,"Retail Invoice Cancel-RoundOff Amount",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 ...
 Begin        
  ...
  Commit Tran        
  -- Entry for RoundOff Account        
  execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,@RoundOffAmount,0,@InvoiceID,@AccountType,"Retail Invoice Cancel-RoundOff Amount",@DocumentNumber        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@RoundOffAmount,@InvoiceID,@AccountType,"Retail Invoice Cancel-RoundOff Amount",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RoundOffAccount)        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
...
----------------------------------------------------------------------------------------------        
 ...
 BEGIN        
  ...
  Begin        
   ...
   execute sp_acc_insertGJ @TransactionID,@NewAccountID,@InvoiceDate,0,@AmtRecd,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
 ...
 Begin        
  ...
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@SumAmtRecd,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
 ...
 Begin        
  ...
  -- Entry for Discount Account        
  execute sp_acc_insertGJ @TransactionID,13,@InvoiceDate,0,@AdjustedAmount,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber --13 ->DiscountAccount        
  -- Entry for Retail Customer Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@AdjustedAmount,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
 ...
 Begin        
  ...
  BEGIN        
   ...
   Begin        
    ...
    End        
    -- Entry for new payment Account        
    execute sp_acc_insertGJ @TransactionID,@NewAccountID,@InvoiceDate,@AmtReturned,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
    Insert Into #TempBackdatedAccounts(AccountID) Values(@NewAccountID)        
   End        
  ...
  Begin        
   -- Entry for Retail Customer Account        
   execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@SumAmtReturned,@InvoiceID,@AccountType,"Retail Invoice Cancellation",@DocumentNumber        
   Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
  End        
 End        
------------------------------Service Charge journal entries-----------------------------        
 ...
 BEGIN        
  ...
  Begin        
   ...
   --execute sp_acc_insertGJ @TransactionID,@NewAccountID,@InvoiceDate,@ServiceCharge,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
   --Insert Into #TempBackdatedAccounts(AccountID) Values(@NewAccountID)        
  End        
 ...
 Begin        
  execute sp_acc_insertGJ @TransactionID,101,@InvoiceDate,@CashSC,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(101) --Cash Service Charge account        
 End        
 If IsNull(@ChequeSc,0) <>0        
 Begin        
  execute sp_acc_insertGJ @TransactionID,102,@InvoiceDate,@ChequeSc,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(102) --Cheque Service Charge account        
 End        
 If IsNull(@CreditCardSc,0) <>0        
 Begin        
  execute sp_acc_insertGJ @TransactionID,103,@InvoiceDate,@CreditCardSc,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(103) --Credit Card Service Charge account        
 End        
 If IsNull(@CouponSc,0) <>0        
 Begin        
  execute sp_acc_insertGJ @TransactionID,104,@InvoiceDate,@CouponSc,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(104) --Coupon Service Charge account        
 End        
 If IsNull(@OthersSc,0) <>0        
 Begin        
execute sp_acc_insertGJ @TransactionID,105,@InvoiceDate,@OthersSc,0,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(105) --Others Service Charge account        
 End        
 If @SumServiceCharge <>0        
 Begin        
  -- Entry for Retail Customer Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@SumServiceCharge,@InvoiceID,@AccountType,"Retail Invoice Cancellation-Service Charge",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
 Set @CashSC=0        
 Set @ChequeSC=0        
...
End        
---------------------------------------------------------------------------------------------      
Else If @NetValue < 0  -- Retail Invoice Salese Return Cancellation        
Begin         
 ...
 Begin        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@NetValue,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
 If @TotalSalesTax<>0        
 Begin        
  -- Entry for Sales Tax Account        
  execute sp_acc_insertGJ @TransactionID,@AccountID2,@InvoiceDate,0,@TotalSalesTax,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)        
 End        
 If @TotalTaxSuffered<>0        
 Begin        
  -- Entry for Sales Tax Account        
  execute sp_acc_insertGJ @TransactionID,@AccountID5,@InvoiceDate,0,@TotalTaxSuffered,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID5)        
 End        
 ...
 Begin
 	...
 	begin  
  		-- Entry for VAT Tax Account              
		execute sp_acc_insertGJ @TransactionID,@VAT_Payable,@InvoiceDate,0,@nVatTaxamount,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
		Insert Into #TempBackdatedAccounts(AccountID) Values(@VAT_Payable)        
	end
 End
 ...
 Begin        
  -- Entry for Sales Account        
  execute sp_acc_insertGJ @TransactionID,@AccountID3,@InvoiceDate,0,@SalesValue,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID3)        
 End        
...
--------------------------------------------------------------------------------------------            
 ...
 Begin        
  ...
  Commit Tran        
  -- Entry for RoundOff Account        
  execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,@RoundOffAmount,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancel-RoundOff Amount",@DocumentNumber        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@RoundOffAmount,@InvoiceID,@AccountType,"Retail Invoice Return Cancel-RoundOff Amount",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RoundOffAccount)        
 End        
 Else If @RoundOffAmount <0        
 Begin        
  ...
  Commit Tran        
  -- Entry for Cash Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@RoundOffAmount,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancel-RoundOff Amount",@DocumentNumber        
  -- Entry for RoundOff Account        
  execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,0,@RoundOffAmount,@InvoiceID,@AccountType,"Retail Invoice Return Cancel-RoundOff Amount",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RoundOffAccount)        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
  Set @RoundOffAmount=0-Abs(@RoundOffAmount)        
 End        
...
---------------------------------------------------------------------------------------------        
 ...
 BEGIN        
  ...
  Set @NewAccountID=@@Identity        
   ...
   End        
   -- Entry for new payment account        
   execute sp_acc_insertGJ @TransactionID,@NewAccountID,@InvoiceDate,@AmtReturned,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
   Insert Into #TempBackdatedAccounts(AccountID) Values(@NewAccountID)        
  End        
 ...
 Begin        
  -- Entry for Retail Customer Account        
  execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@SumAmtReturned,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
  Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
 End        
 --NetValue + Roundoff value < AmountReceived then shortage amount        
 ...
 Begin        
  ...
  Begin        
   ...
   -- Entry for Discount Account        
   execute sp_acc_insertGJ @TransactionID,13,@InvoiceDate,@AdjustedAmount,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber --13 ->DiscountAccount        
   -- Entry for Retail Customer Account        
   execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,0,@AdjustedAmount,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
   Insert Into #TempBackdatedAccounts(AccountID) Values(13)        
   Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
  End        
 End        
 ...
 Begin        
  ...
  BEGIN        
   ...
   Begin        
    ...
    End        
    -- Entry for new payment Account        
    execute sp_acc_insertGJ @TransactionID,@NewAccountID,@InvoiceDate,0,@AmtRecd,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
    Insert Into #TempBackdatedAccounts(AccountID) Values(@NewAccountID)         
   End        
   FETCH NEXT FROM scandynamictable2 INTO @PayMode,@AmtRecd,@Detail,@AmtReturned         
  END        
  ...
  Begin        
   -- Entry for Retail Customer Account        
   execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@SumAmtRecd,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
   Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
  End        
-- -- Get the last TransactionID from the DocumentNumbers table        
--   begin tran        
...
--   -- Entry for Retail Customer Account        
--   execute sp_acc_insertGJ @TransactionID,@RetailCustomer,@InvoiceDate,@ExtraAmount,0,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber        
--   -- Entry for OtherCharges Account        
--   execute sp_acc_insertGJ @TransactionID,14,@InvoiceDate,0,@ExtraAmount,@InvoiceID,@AccountType,"Retail Invoice Return Cancellation",@DocumentNumber --14 ->OtherChargesAccount        
--   Insert Into #TempBackdatedAccounts(AccountID) Values(@RetailCustomer)        
