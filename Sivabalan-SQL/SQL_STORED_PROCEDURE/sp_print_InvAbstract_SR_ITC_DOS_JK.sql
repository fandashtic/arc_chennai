...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_JK](@INVNO INT)     
AS 
Set dateformat DMY         
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_JK @INVNO,1
...
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' Then 'B i l l   o f   S a l e s' Else 
	'T A X   I n v o i c e' End From Customer cu Where cu.CustomerID = Customer.CustomerID), 
"VAT HEADING" = 'V A T   I N V O I C E', 
"VAT INVOICE COPY" = 'Original/Duplicate/Triplicate', 
"VAT DISCLAIMER TEXT" = 'ORIGINAL - Purchaser''s copy (Valid for input tax credit)' + 
			Replicate(' ', (89 - Len('ORIGINAL - Purchaser''s copy (Valid for input tax credit)'))) + 
			'DUPLICATE - Transporter''s copy. This copy does not entitle the holder to tax credit' + 
			Replicate(' ', (88 - Len('DUPLICATE - Transporter''s copy. This copy does not entitle the holder to tax credit'))) +
			'TRIPLICATE - Office copy. This copy does not entitle the holder to tax credit' + 
			Replicate(' ', (92 - Len('TRIPLICATE - Office copy. This copy does not entitle the holder to tax credit'))),
"SALES HEADING" = 'S A L E S   I N V O I C E',
"SALES INVOICE COPY" = 'Original/Duplicate', 
"SALES DISCLAIMER TEXT" = 'Note : Input Credit is not available on this invoice' + 
			Replicate(' ', (55 - Len('Note : Input Credit is not available on this invoice'))) + 
			'ORIGINAL - Purchaser ' + 
			Replicate(' ', (53 - Len('ORIGINAL - Purchaser '))) +
			'Duplicate - Office Copy ' + 
			Replicate(' ', (65 - Len('Duplicate - Office Copy '))),
