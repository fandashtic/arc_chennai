CREATE procedure [dbo].[sp_Save_RetailInvoiceDetail_return_FMCG](@INVOICE_ID int,        
...
if @InvType=5        
	...
	PurchasePrice, SalePrice , Damage,           
	PKD, TaxSuffered, DocType, DocID) VALUES(@ITEM_CODE, @BATCH_NUMBER, @EXPIRY,           
	@REQUIRED_QUANTITY, @COST, @SALE_PRICE,          
	2,  @PKD_DATE, @TAXSUFFERED_ORIG, 6, @INVOICE_ID)    
