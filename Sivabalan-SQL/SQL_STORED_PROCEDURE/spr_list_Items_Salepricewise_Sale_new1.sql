--exec spr_list_Items_Salepricewise_Sale_new1 '04-Apr-2019','04-Apr-2019','%','no'  
CREATE procedure [dbo].[spr_list_Items_Salepricewise_Sale_new1]  
(  
 @FROMDATE datetime,  
 @TODATE datetime,  
...
Begin
	...
	SELECT CUSTOMERId FROM CUSTOMER WITH(NOLOCK) WHERE ISNULL(GSTIN, '') <> '' 
End
Else IF(@WithGST = 'no')
Begin
	INSERT INTO @CUSTOMER(CUSTOMERId)
