...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_Windows_ASL_KL](@INVNO INT)     
AS       
Set dateformat DMY   
...
"TaxPercentage" =  dbo.GetTaxDetails_windows(@INVNO,1),--dbo.GetTaxDetails_windows_NoTaxComp(@INVNO,1),
