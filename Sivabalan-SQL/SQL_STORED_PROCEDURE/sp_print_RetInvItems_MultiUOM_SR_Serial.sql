CREATE procedure [dbo].[sp_print_RetInvItems_MultiUOM_SR_Serial](@INVNO INT)    
AS    
...
"Excise duty" = IsNull(InvoiceDetail.ExciseDuty, 0), "Sales Tax Credit" = InvoiceDetail.STCredit
...
InvoiceDetail.ExciseDuty,InvoiceDetail.STCredit
