Create PROCEDURE sp_list_Dispatch_To_Amend(@CUSTOMER nvarchar(15), @FROMDATE DATETIME,
...
Custname nvarchar(255), Status int, DocumentID int, Original_Ref int) 

/* inserting values into temp table except the last field */
insert into #temp1 (DispatchID, DispatchDate, CustID, Custname, Status, DocumentID)

SELECT DispatchID, DispatchDate, DispatchAbstract.CustomerID, 
Customer.Company_Name, Status, DocumentID
...
union 
Select DispatchID from DispatchAbstract where Original_Reference <> N''
