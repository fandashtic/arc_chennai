Create procedure spr_list_Cust_OutStanding_Pidilite(@Customer nvarchar(2550),
@ToDate datetime)      
As     
...
"Over Due"=(Select Sum(Case InvoiceType When 4 then 0-IsNull(Balance,0)  
...
And Invoicedate <= @todate And Balance <> 0 ),    
