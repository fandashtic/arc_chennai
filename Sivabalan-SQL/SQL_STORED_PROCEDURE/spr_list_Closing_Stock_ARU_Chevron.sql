CREATE procedure [dbo].[spr_list_Closing_Stock_ARU_Chevron]  
(   
@Given_Date DateTime,   
@UOM nVarchar(256)  
)  
...
and Batch_Products.Product_Code = Items.Product_Code
Group By Batch_Products.Product_Code, ItemCategories.Price_Option,Items.Alias
Order by Batch_Products.Product_Code
Else
select OpeningDetails.Product_Code, "Item Code" = OpeningDetails.Product_Code, 
"Saleable Stock" = dbo.sp_Get_ReportingUOMQty(OpeningDetails.Product_Code,Opening_Quantity - Damage_Opening_Quantity), "Free Stock" = dbo.sp_Get_ReportingUOMQty(OpeningDetails.Product_Code,Free_Opening_Quantity),
"Closing Value" = Opening_Value,
"Forum Code" = Items.Alias 
