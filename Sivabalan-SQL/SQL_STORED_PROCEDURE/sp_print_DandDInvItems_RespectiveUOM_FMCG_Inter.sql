Create Procedure [dbo].[sp_print_DandDInvItems_RespectiveUOM_FMCG_Inter](@DnDID INT,@MODE INT=0)
AS
Begin
...
"MRP" =  Case When Duplicate = 1 then cast(cast((Case When #TempTaxDet.MRPPerPack = 0 Then I.MRPPerPack Else #TempTaxDet.MRPPerPack End) as Decimal(18,2)) As nvarchar)  Else  '' End ,
...
"IGSTAmount" = 	Case When Duplicate = 1 then '' Else  Cast(cast(Sum(#TempTaxDet.IGSTAmt ) as Decimal(18,2)) as nvarchar)  End,
