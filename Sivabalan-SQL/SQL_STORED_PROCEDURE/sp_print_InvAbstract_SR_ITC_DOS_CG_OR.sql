...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_CG_OR](@INVNO INT)     
AS          
Set Dateformat DMY
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_OR @INVNO,1
...
"Disclaimer" ='This is a second sale in the state of Odisha',
