...
Create Procedure mERP_sp_Find_SKUSchemeID_Van_New
...
Begin
	...
	Where 
		...
		Select  #tmpScheme.Schemeid,SP.ProductScopeID from SchemeProducts SP,#tmpScheme 
		Where Product_Code = @SKUCode And SP.SchemeID = #tmpScheme.Schemeid And SP.Active = 1
