...
--		(SOLC.OutLetClass = @TMDField4 Or SOLC.OutLetClass = N'All') 
	...
	Where
		...
		@TaxAmt between SSLAB.SlabStart and SSLAB.SlabEnd 
	   and sslab.slabtype in(1,2) 
