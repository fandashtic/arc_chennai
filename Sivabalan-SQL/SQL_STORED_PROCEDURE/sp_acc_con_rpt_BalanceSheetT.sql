CREATE Procedure [dbo].[sp_acc_con_rpt_BalanceSheetT](@FromDate DateTime,@ToDate dateTime)
As
DECLARE @balance decimal(18,2),@TotalDepAmt decimal(18,2),@GroupCode Int,@group nvarchar(250),@AccountType Int,@stockvalue decimal(18,2)
...
Create Table #TempBalanceSheetT(Liability nvarchar(250),LAmount Decimal(18,2),LAccountID Int,
Assets nVarchar(250),AAmount Decimal(18,2),AAccountID Int,ToMatch int null,FromDate datetime null,ToDate datetime null,DocRef integer null,DocType integer null,HighLight Int null)

Create Table #TempAsset(AccountName nvarchar(250),Value Decimal(18,2) null,ToMatch int null,AccountID Int null,FromDate datetime null,ToDate datetime null,DocRef integer null,DocType integer null,SNo Int IDENTITY(1,1) ,HighLight Int null)
Create Table #TempLiability(AccountName nvarchar(250),Value Decimal(18,2) null,ToMatch int null,AccountID Int null,FromDate datetime null,ToDate datetime null,DocRef integer null,DocType integer null,SNo Int IDENTITY(1,1) ,HighLight Int null)
Create Table #TempPL(AccountName nvarchar(25),Debit Decimal(18,2) null,Credit Decimal(18,2) null,
ToMatch int null,AccountID Int null,FromDate datetime null,ToDate datetime null,DocRef integer null,DocType integer null,ToMatch1 Int null,ToMatch2 Int null,HighLight Int null)
...
Begin
	...
	Select 'Profit for the Period' ,@NetDebit,0,0,@fromdate,@todate,0,0,@SPECIALCASE3 from #TempPL where AccountName=N'Net Loss' or AccountName=N'Net Profit'
End

If @NetCredit<>0 
Begin
	Insert #TempAsset
	Select 'Loss for the Period' ,@NetCredit,0,0,@fromdate,@todate,0,0,@SPECIALCASE3 from #TempPL where AccountName=N'Net Loss' or AccountName=N'Net Profit'
End
...
Begin
	...
	Case When #TempLiability.AccountName = N'Profit for the Period' Then #TempLiability.HighLight Else #TempAsset.HighLight End
...
Begin
	...
	Case When #TempAsset.AccountName = N'Loss for the Period' Then #TempAsset.HighLight Else #TempLiability.HighLight End
	from #TempAsset
