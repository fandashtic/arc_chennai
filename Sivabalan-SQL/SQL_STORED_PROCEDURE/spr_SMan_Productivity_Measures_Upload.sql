Create Procedure spr_SMan_Productivity_Measures_Upload
(
...
Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct Top 1 0,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,Null,'All Salesman','All DS Types','NA','All Supervisor','All',0 From #tmpSM
...
Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 1,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,Null,'All Salesman','All DS Types','NA','All Supervisor',I.GroupName,0 From #tmpSM T,#TmpINV I Order By I.GroupName

Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 0,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,SalesManID,SalesMan_name,Dstype,HH,Supervisor,'All',0 From #tmpSM
...
Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 2,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,Null,'All Salesman','All DS Types','NA','All Supervisor',I.Division,0 From #tmpSM T,#TmpINV I Order By I.Division

Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 1,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,SalesManID,SalesMan_name,Dstype,HH,Supervisor,GroupName,CatGrpCount From #tmpSM Order By GroupName

Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 3,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,Null,'All Salesman','All DS Types','NA','All Supervisor',I.SubCategory,0 From #tmpSM T,#TmpINV I Order By I.SubCategory

Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 2,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,SalesManID,SalesMan_name,Dstype,HH,Supervisor,Division,DivCount From #tmpSM Order By Division

Insert Into #tmpOutputdata([WDCode],[WD Code],[WD Dest Code],[From Date],[To Date],[WK From Date],[WK To Date],[Salesman ID],[Salesman Name],[Salesman Type],[Handheld DS],[Supervisor],[Category Level],[Total Outlets])
Select Distinct 3,@WDCode,@WDDestCode,Fromdate,Todate,WKFromdate,WKTodate,SalesManID,SalesMan_name,Dstype,HH,Supervisor,SubCategory,SubCatCount From #tmpSM Order By SubCategory
...
Select Distinct * From #tmpFinalOutputdata Order By [Salesman ID],[WDCode] Asc
