CREATE PROCEDURE mERP_spr_OpenSchemeCreditNoteRpt_Upload
(
    @FROMDATE datetime,      
	@TODATE datetime, 
	@SHOW nVarChar(20)
...
From CreditNote crn, tbl_mERP_SchemePayoutPeriod spp, tbl_mERP_SchemeAbstract sa ,Customer C,tbl_mERP_OLClass OLC, tbl_mERP_OLClassMapping OLM
...
And	crn.Balance = Case @SHOW When 'All' Then crn.Balance 
	...
	And IsNull(crn.Status, 0) & 192 = 0 And crn.DocumentDate Between @FROMDATE and @TODATE --<=@TODATE 
    And IsNull(Flag,0) = 1 
