CREATE procedure [dbo].[sp_print_RetInvItems_MultiUOM_Template_Pidilite](@INVNO INT)        
AS        
...
SELECT "Item Code" = InvoiceDetail.Product_Code, "Item Name" = Items.ProductName,         
 ...
 "UOMPrice" =     
  ...
  "Free Qty" = (Select sum(InvDet.Quantity)   
    ...
    And InvDet.Product_Code = InvoiceDetail.Product_Code and FlagWord = 1 and invdet.serial = invoicedetail.freeserial ),
