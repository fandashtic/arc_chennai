Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_Exempted_ITC_GST](@INVNO INT,@MODE INT=0)
AS
Begin
...
"Quantity" =Isnull(cast(Case When Duplicate=1 then Cast((Case When InvoiceDetail.UOMPrice <> 0
...
Else Cast(Cast(0 as decimal(18,2))as nVarchar)
End,''),
--GST_Changes ends here
"UOM" = UOM.Description,
--GST_Changes starts here
...
"TaxableValue" = Cast(0 As nVarChar), --GST_Changes
...
UOM='',Amount='',[Net Value]='',[Net Amount]='',Serial=0,[SNo]='',[Sale Price]='',
[Item MRP]='',TaxDetailsWithBreakup = '',[Discount Value]='',[Discount%]='',TaxDetails='',[Batch No.]='' ,
[Total Tax] = '',[Other Disc] = '',[Quantity]='',[Free]='',[Item Gross Value]=''  Where Duplicate = 2
--GST_Changes ends here
