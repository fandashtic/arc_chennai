Create Procedure [dbo].[mERP_SP_ListApplicableITemScheme_VS]  
(@szSKUCode as nvarchar (30),  
...
Begin  
	...
	Declare @ScopeID Int  
	Declare @SKUCode as nVarchar(30)  	  
	...
	Create table #TempSchemeAbstract  
	(SchemeID Int  
	, CS_RecSchID Int  
	, ActivityCode nVarchar(500) Collate SQL_Latin1_General_CP1_CI_AS  
	, Description nVarchar(500) Collate SQL_Latin1_General_CP1_CI_AS  
	, ActiveFrom Datetime  
	, ActiveTo Datetime  
	, CSApplicableOn nVarchar(30) Collate SQL_Latin1_General_CP1_CI_AS  
	, ItemGroup nVarchar(30) Collate SQL_Latin1_General_CP1_CI_AS  
	, GroupID Int  
	, SABSApplicableOn Int  
	, SABSItemGroup Int)  	  	  
	  
	Declare VS_Item Cursor for Select * from dbo.sp_SplitIn2Rows(@szSKUCode, ',')  
	  
	Open VS_Item  
	Fetch Next From VS_Item Into @SKUCode  
	...
	Insert into #TempSchemeAbstract  
	...
	Select distinct * from #TempSchemeAbstract   
End  
