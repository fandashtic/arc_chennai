Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC](@INVNO INT)     
AS          
...
--For ExciseDuty  
"Excise Duty" = InvoiceAbstract.ExciseDuty,
"additional adjustment" = dbo.GetAdjustmentValue(@INVNO, 1),
"Write Off" = dbo.GetAdjustmentValue(@INVNO, 2),
...
"TaxBreakup" = dbo.MERP_FN_GetInvoiceTaxComponentDetails_ITC(@INVNO),
"CreditNoteDetails" = dbo.MERP_FN_GetCreditNoteDetails(@INVNO),
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' Then 'Bill of sales' Else 
	'TAX Invoice' End From Customer cu Where cu.CustomerID = Customer.CustomerID)
