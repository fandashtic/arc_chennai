CREATE PROCEDURE [dbo].[sp_get_InvDetails](@CustomerID NVARCHAR(15), @Inv_No INT)        
AS        
...
--AND 
--Items.Product_Code = InvDt.Product_Code    
--AND Items.CategoryID *= ItemCategories.CategoryID AND BP.Batch_Code =* InvDt.Batch_Code  
