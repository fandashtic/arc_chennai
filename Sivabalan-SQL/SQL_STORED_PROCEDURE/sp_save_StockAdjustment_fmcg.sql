CREATE Procedure sp_save_StockAdjustment_fmcg(@STOCKID INT,        
...
BEGIN        
 ...
 SalePrice, Damage, DamagesReason, PKD, GRN_ID, TaxSuffered, Free, GRNTaxSuffered, GRNTaxID, GRNApplicableOn, GRNPartOff, ApplicableOn, PartofPercentage, Vat_Locality, DocType, DocId)        
 Values(@Batch_Number, @EXPIRY, @ITEM_CODE, ABS(@ADJUSTMENT_QTY), @ADJUSTMENT_PRICE,         
 @SALE_PRICE, 1, @REASON_ID, @PKD_DATE, @GRN_ID, @TAXSUFFERED, @Free, @GRNTaxSuffered, @GRNTaxId, @GRNApplicableOn, @GRNPartOff, @ApplicableOn, @PartOff, @Vat_Locality, 2, @STOCKID)        
