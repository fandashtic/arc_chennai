CREATE Procedure sp_Save_GSTInvoiceTaxComponentsSplit_Detail
...
Begin
	...
	Insert Into GSTInvoiceTaxComponents(InvoiceID,Product_Code,SerialNo,TaxType,Tax_Code,Tax_Component_Code,Tax_Percentage,Tax_Value,
			FirstPoint,STCreditFlag,STCreditAmt,NetTaxAmount)
	Select @InvoiceID,@ProductCode,@RowNo,@TaxType,@TaxCode,Cast(TC1_TaxComponent_code as int),TC2_Tax_percentage,TC9_TaxAmt,
