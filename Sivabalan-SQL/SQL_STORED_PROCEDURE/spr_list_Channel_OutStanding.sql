CREATE procedure spr_list_Channel_OutStanding(@FromDate datetime,  
					      @ToDate datetime)  
as 
...
Sum(Case InvoiceAbstract.InvoiceType When 4 then 0-Isnull(InvoiceAbstract.Balance,0) Else IsNull(InvoiceAbstract.Balance,0) End),
...
group by IsNull(Customer.ChannelType, 0)
