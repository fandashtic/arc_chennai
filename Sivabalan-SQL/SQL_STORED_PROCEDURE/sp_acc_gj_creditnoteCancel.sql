CREATE procedure sp_acc_gj_creditnoteCancel(@creditid integer,@BackDate DATETIME=Null)
as
...
set @ndoctype=65        /* Constant to store the Document Type*/
...
Create Table #TempBackdatedcreditnotecancel(AccountID Int) --for backdated operation
...
begin                                   
	...
	begin
		...
		begin
			...
			Values(@documentid,@accountid,@ddocumentdate,@nnotevalue,0,@ncreditid,@ndoctype,'Credit Note For Customer-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@accountid) 
		end
		...
		begin
			insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])
			Values(@documentid,@expensesid,@ddocumentdate,0,@nnotevalue,@ncreditid,@ndoctype,'Credit Note For Customer-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@expensesid) 
		end
	end
end
else if @nmode =2
begin                                   
	...
	begin 
		...
		begin
			insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])
			Values(@documentid,@accountid,@ddocumentdate,@nnotevalue,0,@ncreditid,@ndoctype,'Credit Note For Vendor-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@accountid) 
		end
		if @nnotevalue <> 0
		begin
			insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])
			Values(@documentid,@expensesid,@ddocumentdate,0,@nnotevalue,@ncreditid,@ndoctype,'Credit Note For Vendor-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@expensesid) 
		end
	end
end
...
begin                                   
	...
	begin 
		...
		begin
			insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])
			Values(@documentid,@accountid,@ddocumentdate,@nnotevalue,0,@ncreditid,@ndoctype,'Credit Note For Others-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@accountid) 
		end
		if @nnotevalue <> 0
		begin
			insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])
			Values(@documentid,@expensesid,@ddocumentdate,0,@nnotevalue,@ncreditid,@ndoctype,'Credit Note For Others-Cancellation',@uniqueid)  
			Insert Into #TempBackdatedcreditnotecancel(AccountID) Values(@expensesid) 
		end
	end
end
...
Begin
	...
	Select AccountID From #TempBackdatedcreditnotecancel
...
End
Drop Table #TempBackdatedcreditnotecancel
