CREATE PROCEDURE [dbo].[sp_get_InvDetails_VanLoading_FMCG_MUOM](@CustomerID NVARCHAR(15), @Inv_No INT)    
AS    
...
--AND BP.Batch_Code =* VSD.Batch_Code 
--AND InvDt.Batch_Code = VSD.[ID]
