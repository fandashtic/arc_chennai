CREATE Procedure sp_save_InvoiceDetail_muom    
                        (@INVOICEID INT,    
...
Select @HSNNumber = isnull(HSNNumber,0), @CategorizationID = isnull(CategorizationID,0) From Items Where Product_Code = @PRODUCTCODE
...
INSERT INTO InvoiceDetail    
 ...
 UOM,   
 UOMQty ,  
 UOMPrice,GSTFlag,GSTCSTaxCode,HSNNumber,CategorizationID  )    
VALUES     
 (@INVOICEID,     
 @PRODUCTCODE,    
 @BATCH_CODE,    
