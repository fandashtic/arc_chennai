...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_Windows_JK](@INVNO INT)     
AS 
Set dateformat DMY         
...
"VAT DISCLAIMER TEXT" = 'ORIGINAL - Purchaser''s copy (Valid for input tax credit)' + 
			Replicate(' ', (99 - Len('ORIGINAL - Purchaser''s copy (Valid for input tax credit)'))) + 
...
"SALES DISCLAIMER TEXT" = 'Note : Input Credit is not available on this invoice' + 
			...
			'ORIGINAL - Purchaser ' + 
			Replicate(' ', (63 - Len('ORIGINAL - Purchaser '))) +
