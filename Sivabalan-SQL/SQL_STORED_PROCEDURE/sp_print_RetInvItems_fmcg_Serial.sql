CREATE procedure [dbo].[sp_print_RetInvItems_fmcg_Serial](@INVNO INT)      
AS      
...
"Payment Details" = Replace(Replace(dbo.fn_PaymentDetail(@INVNO,1), N';', CHAR(13) + CHAR(10)), N':', CHAR(9)),                    
...
Order By InvoiceDetail.serial,InvoiceDetail.Product_Code Asc, InvoiceDetail.SalePrice Desc
