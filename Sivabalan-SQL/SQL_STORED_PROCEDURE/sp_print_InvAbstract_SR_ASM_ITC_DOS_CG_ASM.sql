...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ASM_ITC_DOS_CG_ASM](@INVNO INT)     
AS          
Set Dateformat DMY
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_ASM @INVNO,1
--Select 1 
...
"TIN/NON TIN" = 'R E T A I L  I N V O I C E',
"Disclaimer" = 'This is a Second sale in the State of Assam.', 
