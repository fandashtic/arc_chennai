CREATE Procedure sp_acc_rpt_balancesheetdetail(@fromdate datetime,@todate datetime ,@parentid  integer,@docref integer,@doctype integer,@mode integer,@Info nvarchar(4000) = Null,@State Int=0,@Hide0BalAC Int =0)
as          
...
Begin        
  exec sp_acc_rpt_tradingacdetail @Fromdate,@Todate, @parentid, @docref, @doctype, @mode, @Info, @State        
  goto Quit        
End        
