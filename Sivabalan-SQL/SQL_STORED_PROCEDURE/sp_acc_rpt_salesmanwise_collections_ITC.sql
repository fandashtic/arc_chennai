CREATE PROCEDURE sp_acc_rpt_salesmanwise_collections_ITC(@FROMDATE datetime, @TODATE datetime)    
AS    
Create table #temp1    
(     
	Collid Integer,    
	SManid nvarchar(40) COLLATE SQL_Latin1_General_CP1_CI_AS,    
	SManName nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS,    
...
"Write Off Amount"=(Select dbo.fn_GetWriteOff(Collections.DocumentID)),
"Col Discount" = (Select dbo.fn_GetCollectionDiscount(Collections.DocumentID))
From Collections
Left Outer Join Salesman  On Collections.SalesmanID = Salesman.SalesmanID
Where Collections.DocumentDate between @FROMDATE And @TODATE     
...
"Collection Discount" = Sum(IsNull(ColDiscount,0))  
from #temp1     
