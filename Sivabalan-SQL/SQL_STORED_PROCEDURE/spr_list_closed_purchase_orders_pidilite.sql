CREATE procedure [dbo].[spr_list_closed_purchase_orders_pidilite](@FROMDATE datetime,
					  @TODATE datetime)
AS
...
FROM POAbstract, Vendors, VoucherPrefix POPrefix, VoucherPrefix GRNPrefix, ClientInformation,Brand
