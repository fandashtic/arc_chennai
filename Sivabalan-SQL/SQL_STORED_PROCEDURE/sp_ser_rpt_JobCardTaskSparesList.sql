CREATE procedure sp_ser_rpt_JobCardTaskSparesList(@Item nvarchar(255))                
as                
...
begin                              
	...
	'TaskID' = jobcarddetail.Taskid, 'Description' = Taskmaster.[Description], 'ColumnKey' = 2
...
begin                
	Select '','Spare Code'  = jobcarddetail.SpareCode,           
	'Spare Name' = productname,                
	'UOM'= UOM.[Description],               
	'Qty' = Isnull(UomQty,0),              
	'Date of Sale' = DateofSale,          
	(case Isnull(Warranty,'') when 1 then 'Yes' when 2 then 'No'else 'No' end) as 'Warranty',                 
	'Warranty No' = Isnull(WarrantyNo,''), 'ColumnKey' = 3 
