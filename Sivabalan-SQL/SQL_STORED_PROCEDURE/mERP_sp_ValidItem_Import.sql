Create Procedure [dbo].[mERP_sp_ValidItem_Import](@ItemInfo nVarchar(2000))
As
Begin
...
Else If Not Exists(Select *  From uom Where Description = @UOM And Active = 1)
Set @ErrMsg = 'InActive UOM'
