CREATE Procedure sp_Save_SOAbstract_ITC   
(    
 ...
 @GroupID nVarchar(1000) = NULL,@ForumSC Int = 1,@SuperVisorID Int = 0,@UserName nvarchar(2000) =''
)    
AS    
...
ForumSC,SupervisorID,UserName,FromStateCode,ToStateCode,GSTIN,GSTFlag
)    
Values      
(    
