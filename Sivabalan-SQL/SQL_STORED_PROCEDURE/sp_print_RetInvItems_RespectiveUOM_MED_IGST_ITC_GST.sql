Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_MED_IGST_ITC_GST](@INVNO INT,@MODE INT=0)
AS
Begin
...
+' | '+ Cast(Cast(Sum(InvoiceDetail.Quantity) As decimal(20,4)) As nvarchar(20)) + +' '+ Cast(InvoiceDetail.BaseUOMDescription  As nvarchar(5)) As nVarchar(50))
...
[Discount Value]='',TaxDetails='',[Batch No.]='',[Total Tax] = '' ,[Other Disc] = ''
Where Duplicate = 2
--GST_Changes ends here
