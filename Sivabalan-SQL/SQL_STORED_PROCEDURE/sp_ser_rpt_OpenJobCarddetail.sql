CREATE procedure sp_ser_rpt_OpenJobCarddetail (@JobCardID int)                            
as                            
...
Create table #OpenJobcardDetail_Temp([_JobCardID] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS,[_Delivery Date] datetime null)        
                                
set @Iteminfo =  'Alter table #OpenJobcardDetail_Temp Add 
...
Insert into #OpenJobcardDetail_Temp                                    
...
Set @Iteminfo1 = 'Select [_JobCardID] as "JobCardID",
...
[_Door Delivery] as "Door Delivery",[_Time in] as "Time In",
[_Delivery Date] as "Delivery Date",[_Delivery Time] as "Delivery Time"
from #OpenJobcardDetail_Temp'

Exec Sp_executesql @Iteminfo1      

Drop Table #OpenJobcardDetail_Temp      
