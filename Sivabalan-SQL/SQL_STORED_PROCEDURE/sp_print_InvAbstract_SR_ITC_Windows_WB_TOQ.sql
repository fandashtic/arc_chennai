...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_Windows_WB_TOQ](@INVNO INT)     
AS        
Set dateformat DMY  
...
"TaxPercentage" =  dbo.GetTaxDetails_windows_TOQ(@INVNO,1),
"SalesValue" = dbo.GetTaxDetails_windows_TOQ(@INVNO,2),
"TaxCompPercentage" =  dbo.GetTaxDetails_windows_TOQ(@INVNO,3),
"TaxAmt" =  dbo.GetTaxDetails_windows_TOQ(@INVNO,4),
"TotalTaxAmt" =  dbo.GetTaxDetails_windows_TOQ(@INVNO,5),
