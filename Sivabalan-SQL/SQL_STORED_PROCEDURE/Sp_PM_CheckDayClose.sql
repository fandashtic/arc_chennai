Create Procedure dbo.Sp_PM_CheckDayClose 
As  
Begin
	Set DateFormat DMY
	...
	select Distinct PMID from tbl_mERP_PMMaster Where Period in (@PMMonth) and Active = 1 and dbo.StripDateFromTime(Creationdate) <= @CheckDate and Isnull(AutoPost , 0) = 0
