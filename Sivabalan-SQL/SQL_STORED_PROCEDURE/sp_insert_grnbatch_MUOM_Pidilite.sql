CREATE PROCEDURE sp_insert_grnbatch_MUOM_Pidilite(@GRNID int,         
...
INSERT INTO Batch_Products(Batch_Number,        
      ...
      UOMPrice,TaxSuffered,GRNTaxSuffered,GRNTaxID,GRNApplicableOn,GrnPartOff,   
 	  ApplicableOn, PartOfPercentage, Vat_locality, DocType,ReceInvItemOrder)              
VALUES (@BATCH_NUMBER,        
  @PRODUCT_CODE,        
  @GRNID,        
  @EXPIRY,        
  ...
  @APPLICABLEON, @PARTOFF, @Vat_Locality, @DocType,@ItemOrder)   
