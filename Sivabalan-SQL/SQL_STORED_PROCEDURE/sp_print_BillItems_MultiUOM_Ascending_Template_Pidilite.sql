CREATE procedure [dbo].[sp_print_BillItems_MultiUOM_Ascending_Template_Pidilite](@BillNo INT)    
...
"Octroi Amount" = Sum(IsNull(OctroiAmount,0)),"Freight" = Sum(IsNull(Freight,0)), 'BillDiscountMaster'      
