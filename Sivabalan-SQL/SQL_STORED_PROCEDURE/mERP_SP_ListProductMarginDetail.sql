Create Procedure mERP_SP_ListProductMarginDetail(@Date DateTime = Null,@Level int)
As
...
Begin
  ...
  Level,  
  cast(isNull(dbo.merp_fn_Get_CategoryMargin(#TempCategory.Code,@Date,Level,'Percentage'),0) as decimal(18,6))
   'Percentage',
  ...
  order by Division,SubCategory,MarketSKU,Cast(SystemSKU As nVarchar(510)),Level
