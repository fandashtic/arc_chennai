CREATE procedure sp_ser_rpt_CancelTaskSparesList(@Item nvarchar(255))                    
as                    
...
begin                    
	...
	'TaskID' = Estimationdetail.Taskid,Taskmaster.[Description],                    
...
Else if  @Type = '3'                 
Begin            
	select Estimationdetail.SpareCode,'Spare Code' = Estimationdetail.SpareCode, 'Spare Name' = productname,                    
	'UOM'= UOM.[Description],                   
	'Qty' = Isnull(UomQty,0),                  
	'Sale Price' = Isnull(Uomprice,0),SalesTax,
	'Sales Tax Amount' = (Isnull(LSTPayable,0) + Isnull(CSTpayable,0)),                    
	'TaxSuffered Percentage' = Taxsuffered_Percentage,                    
