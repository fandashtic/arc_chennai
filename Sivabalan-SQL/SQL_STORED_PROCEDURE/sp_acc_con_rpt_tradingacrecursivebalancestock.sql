CREATE procedure sp_acc_con_rpt_tradingacrecursivebalancestock(@parentid integer,@fromdate datetime, @todate datetime,@balance decimal(18,2) output,@SPECIALFORMAT Int = 0)
as
Set @balance=0
