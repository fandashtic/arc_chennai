CREATE procedure [dbo].[spr_list_purchase_orders_by_vendor_pidilite](@VendorID nvarchar (2550),
                                                    @FROMDATE datetime,
						    @TODATE datetime)
AS
...
FROM POAbstract, VoucherPrefix POPrefix, VoucherPrefix GRNPrefix, Vendors, ClientInformation,Brand
