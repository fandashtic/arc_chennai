CREATE PROCEDURE sp_get_PTRPrice(@ItemCode as nvarchar(15))        
AS        
BEGIN        
...
BEGIN        
 IF @PRICE_OPTION=1         
 BEGIN        
  Select Top 1 Batch_Code, Batch_Number, isnull(Expiry,''),isnull(PKD,''),PTR
  From Batch_Products        
 ...
 ELSE    
 BEGIN        
  Select Top 1 Batch_Code, Batch_Number, isnull(Expiry,''),isnull(PKD,''),Items.PTR        
