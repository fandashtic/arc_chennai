Create Procedure sp_Get_CategoryProperty_Info (@UniqueID Int, @CategoryID Int)
As
...
Property_Name In (Select PropertyName From CategoryPropertyReceived Where
CategoryID = @UniqueID)
...
Select PropertyName From CategoryPropertyReceived Where CategoryID = @UniqueID And
