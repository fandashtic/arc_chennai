...
Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_GUJARAT](@INVNO INT,@MODE INT = 0)          
AS  
Begin  
...
InvoiceAbstract.TaxOnMRP,Items.TaxSuffered,Items.Sale_Tax,IsNull(InvoiceDetail.MRPPerPack,0),Items.MRPPerPack, 	
 InvoiceDetail.Batch_Number,Batch_Products.PKD,Batch_Products.Expiry,
