...
Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_SR_ITC_KA](@INVNO INT,@MODE INT = 0)          
AS  
Begin  
...
"Batch No." =isnull(InvoiceDetail.Batch_Number,''),
"Mfr. Dt." =dbo.fn_dateMY(Batch_Products.PKD),
"Expiry" =dbo.fn_dateMY(Batch_Products.Expiry),
