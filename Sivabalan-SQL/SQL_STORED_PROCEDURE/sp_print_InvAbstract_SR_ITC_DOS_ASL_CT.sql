...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_ASL_CT](@INVNO INT)     
AS       
Set dateformat DMY   
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_CT @INVNO,1
--Select  1
...
Inner Join CreditTerm  On InvoiceAbstract.CreditTerm = CreditTerm.CreditID                    
WHERE InvoiceID = @INVNO           
