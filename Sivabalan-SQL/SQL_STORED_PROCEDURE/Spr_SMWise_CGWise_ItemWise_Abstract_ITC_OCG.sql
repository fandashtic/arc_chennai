Create Procedure Spr_SMWise_CGWise_ItemWise_Abstract_ITC_OCG        
(        
...
Begin
	If @CategoryGrouptype <> 'Operational'
		Insert InTo #TmpGroup select distinct PCG.GroupID from tblcgdivmapping cg ,ProductCategoryGroupAbstract PCG where CG.CategoryGroup=PCG.GroupName
	else		
		Insert InTo #TmpGroup Select Distinct GroupID From ProductCategoryGroupAbstract where OCGtype = 1 
End
Else        
...
SalesMan+char(15)+Beat+char(15)+GroupName+char(15)+@CategoryGrouptype,
