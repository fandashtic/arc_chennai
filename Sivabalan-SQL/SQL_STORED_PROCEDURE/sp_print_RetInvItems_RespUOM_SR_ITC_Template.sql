Create PROCEDURE sp_print_RetInvItems_RespUOM_SR_ITC_Template(@INVNO INT)          
AS  
Begin  
...
SELECT  
 ...
 "Excise duty" = IsNull(InvoiceDetail.ExciseDuty, 0),"Serial" = InvoiceDetail.Serial , "TaxComponent" = NULL , "Sales Tax Credit" = InvoiceDetail.STCredit, "Sold As" = Items.Soldas
Into  
 #TmpInvDet    
...
-- + SubString(CAST(DATEPART(yy, Batch_Products.PKD) AS nvarchar), 3, 2),          
 ...
 InvoiceDetail.ExciseDuty, InvoiceDetail.UOM,InvoiceDetail.TaxID  ,InvoiceDetail.STCredit, Items.Soldas,
