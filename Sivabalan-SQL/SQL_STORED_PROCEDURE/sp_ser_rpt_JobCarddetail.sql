CREATE  procedure sp_ser_rpt_JobCarddetail (@JobCardID int)                              
as                              
...
Create table #JobcardDetail_Temp([_JobcardID] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS,[_Delivery Date] datetime null)
                              
set @Iteminfo =  'Alter table #JobcardDetail_Temp Add [_Item Code] nvarchar(50)COLLATE SQL_Latin1_General_CP1_CI_AS ,
...
Insert into #JobcardDetail_Temp                                  
...
from #JobcardDetail_Temp'

Exec sp_executesql @Iteminfo1
    
Drop Table #JobcardDetail_Temp    
