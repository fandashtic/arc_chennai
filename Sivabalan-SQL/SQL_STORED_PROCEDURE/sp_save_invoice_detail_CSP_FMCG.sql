CREATE Procedure sp_save_invoice_detail_CSP_FMCG(@INVOICE_ID int,
...
BEGIN
	...
	Amount, PurchasePrice, STPayable, MRP, TaxID, FlagWord, SaleID, TaxCode2, CSTPayable, TaxSuffered, TaxSuffered2)
	VALUES (@INVOICE_ID, @ITEM_CODE, 0, N'', @REQUIRED_QUANTITY, @MODIFIED_PRICE, @TAXCODE, @DISCOUNTPERCENTAGE, @DISCOUNTAMOUNT, @AMOUNT, 
	@COST * @REQUIRED_QUANTITY, @STPAYABLE, @MRP, @TAXID, @FLAG, @SALEID, @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2)
...
BEGIN
	...
	@REQUIRED_QUANTITY * @COST, @STPAYABLE, @MRP, @TAXID, @FLAG, @SALEID, @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2)
	...
	@COST * @QUANTITY, @STPAYABLE, @MRP, @TAXID, @FLAG, @SALEID, @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2)
	SET @TAXCODE = 0
