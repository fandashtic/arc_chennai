CREATE procedure sp_ser_rpt_ItemwiseOpenEstimation(@ITEM nvarchar(255))                
AS                
...
'Total' = IsNUll(Sum(Netvalue),0), 'ColumnKey' = 0
...
'Total' = IsNUll(Sum(Netvalue),0) + IsNull(dbo.sp_ser_rpt_getTaskSparesAmount            
(EstimationID, @Itemspec1, Type,EstimationDetail.TaskId,2), 0), 'ColumnKey' = 0                       
...
Group by EstimationID, Type,product_specification1, EstimationDetail.TaskId,[description],Estimationdetail.sparecode                      
Union                       
