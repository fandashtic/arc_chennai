CREATE Procedure sp_acc_gj_outputserviceinvoice (@invoiceid INT,@BackDate DATETIME=Null)
AS
...
Set @AccountType = 153 --Output Service Invoice
...
If @NetValue<>0
Begin
execute sp_acc_insertGJ @TransactionID,@PartyID,@Invoicedate,@NetValue,0,@invoiceid,@AccountType,"Output Service Invoice",@DocumentNumber
...
begin
execute sp_acc_insertGJ @TransactionID,@AccountID,@InvoiceDate,0,@TaxableValue,@InvoiceID,@AccountType,"Output Service Invoice",@DocumentNumber
...
begin
execute sp_acc_insertGJ @TransactionID,@gst_payable,@InvoiceDate,0,@nGSTaxAmt,@InvoiceID,@AccountType,"Output Service Invoice",@DocumentNumber
