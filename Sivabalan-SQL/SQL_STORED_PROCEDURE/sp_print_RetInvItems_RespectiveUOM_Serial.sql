CREATE procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_Serial] (@INVNO INT)        
AS        
...
"PKD" = CAST(DATEPART(mm, max(Batch_Products.PKD)) AS nvarchar) + '\'      
...
GROUP BY Invoicedetail.serial,InvoiceDetail.Product_code, Items.ProductName, InvoiceDetail.Batch_Number,InvoiceDetail.SalePrice,
