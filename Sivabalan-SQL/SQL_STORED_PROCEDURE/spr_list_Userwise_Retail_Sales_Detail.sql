CREATE procedure [dbo].[spr_list_Userwise_Retail_Sales_Detail] (@PaymentMode nvarchar(50),                          
               @FromDate Datetime,                          
...
Create table #Temp(PaymentMode nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS,InvoiceID nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS, Customer nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS, Invoicedate datetime, NetValue Decimal(18,6), Discount Decimal(18,6),GrossValue Decimal(18,6),AmountCollected Decimal(18,6))                  
...
WHILE @@Fetch_status = 0        
 ...
 group by DocumentID,Company_Name,InvoiceDate ,DiscountValue ,GrossValue,NetValue,Freight,InvoiceAbstract.InvoiceID  
...
DEALLOCATE PayMode                         
 ...
 Select distinct InvoiceID,Customer,InvoiceDate,NetValue,Discount,GrossValue into #Temp1 from #Temp     
 ...
 while @@Fetch_status = 0          
Begin          
  set @StrSql1 = N'Update #Temp1 set [' + @Mode + N'] = ' + cast(@Amt as nvarchar) +  N' Where InvoiceID = N''' + @InvID + ''''           
...
Else        
 ...
 Create Table #Temp2 (InvoiceID nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS,Customer nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS,[Invoice Date] datetime,[Net Value] Decimal(18,6),Discount Decimal(18,6),GrossValue Decimal(18,6))        
