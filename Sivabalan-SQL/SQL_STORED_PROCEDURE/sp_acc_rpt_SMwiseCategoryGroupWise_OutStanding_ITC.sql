CREATE procedure sp_acc_rpt_SMwiseCategoryGroupWise_OutStanding_ITC(
...
-----------------------------------------------------------------	
	...
	If @TimeBucket1 = 0 And @TimeBucket2 = 0 And @TimeBucket3 = 0 And @TimeBucket4 = 0 And @TimeBucket5 = 0 And @TimeBucket6 = 0  And @TimeBucket7 = 0 And @TimeBucket8 = 0  And @TimeBucket9 = 0 And @TimeBucket10 = 0 
	Begin
		Select Cast(#temp.SalesmanID As nVarchar) + '; ' + Cast(#temp.GroupId As nVarchar), "Salesman" = IsNull(Salesman.Salesman_Name, dbo.LookupDictionaryItem('Others',Default)), 
	...
	Else
	Begin
		Select "SalesManId" = Cast(#temp.SalesmanID As nVarChar) + '; ' + Cast(#temp.GroupId As nVarchar), 
