...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_ASL_DOS_UP](@INVNO INT)     
AS    
Set dateformat DMY      
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_UP @INVNO,1
--Select  1
...
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' Then 'S A L E S  I N V O I C E' Else 
