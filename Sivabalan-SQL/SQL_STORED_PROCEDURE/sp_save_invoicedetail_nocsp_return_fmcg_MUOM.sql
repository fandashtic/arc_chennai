CREATE Procedure sp_save_invoicedetail_nocsp_return_fmcg_MUOM(@INVOICE_ID int,  
...
ELSE  
	...
	ELSE  
		...
		VALUES(@ITEM_CODE, @BATCH_NUMBER, @EXPIRY, @REQUIRED_QUANTITY, @COST, @SALE_PRICE,   
		2, @REASON_ID, @PKD_DATE, @TAXSUFFERED_ORIG,1,@INVOICE_ID)  
...
BEGIN  
	...
	@SALE_PRICE * @ORIGINAL_QTY, @SCHEME_COST, @SCHEMEID, @INVOICE_ID, 0, @ORIGINAL_QTY)  
END  
SELECT @RETVAL  
