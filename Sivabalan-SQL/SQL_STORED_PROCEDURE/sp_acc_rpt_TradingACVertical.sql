CREATE Procedure sp_acc_rpt_TradingACVertical(@FromDate DateTime, @Todate DateTime)
As
...
Declare @GrossValue Decimal(18,6),@NetExpAmount Decimal(18,6),@NetIncAmount Decimal(18,6)
Declare @NetIID Decimal(18,6),@NetEID Decimal(18,6),@netValue Decimal(18,6)
...
SET @SALESACCOUNT=28
	...
	Create table #TempTrading(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTrading1(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTradingED(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTradingID(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	--Create table #TempTradingInDirect(AccountName nvarchar(25),Debit Decimal(18,6),Credit Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTradingIID(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTradingEID(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)

	Create table #TempTradingIID1(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	Create table #TempTradingEID1(AccountName nvarchar(25),Amount Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
	...
	Select dbo.LookupDictionaryItem('Opening Stock',Default),IsNull(@Balance,0),@OPENINGSTOCKGROUP,@FromDate,@ToDate,0,0,@ACCOUNTGROUP -- Opening Stock GroupID
	...
	Insert #TempTradingID
	Select dbo.LookupDictionaryItem('Closing Stock',Default),IsNull(@Balance,0),@CLOSINGSTOCKGROUP,@FromDate,@ToDate,0,0,@ACCOUNTGROUP -- Closing Stock GroupID
...
-- 			end
	...
	Select "Group Name" = AccountName ,Amount ,0,AccountID,FromDate ,ToDate ,DocRef ,DocType ,HighLight,Case when AccountName=N'Net Profit' then Amount else (Case When AccountName=N'Net Loss' Then (0-Amount) Else Null End) End, HighLight  from #TempTrading
