CREATE Procedure [dbo].[sp_acc_rpt_TradingACTShape](@FromDate DateTime, @Todate DateTime)
As
...
Create table #TempTradingT(Debit nvarchar(25),EAmount Decimal(18,6),EAccountID Int,
Credit nvarchar(50),IAmount Decimal(18,6),IAccountID Int,
FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)


Create table #TempTrading(Expense nvarchar(25),EAmount Decimal(18,6),EAccountID Int,
Income nvarchar(50),IAmount Decimal(18,6),IAccountID Int,
FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)

Create table #TempTrading1(Expense nvarchar(25),EAmount Decimal(18,6),EAccountID Int,
Income nvarchar(50),IAmount Decimal(18,6),IAccountID Int,
FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)

Create table #TempTradingED(AccountName nvarchar(25),Amount Decimal(18,6),SNo Int IDENTITY(1,1),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
Create table #TempTradingID(AccountName nvarchar(25),Amount Decimal(18,6),SNo Int IDENTITY(1,1),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
--Create table #TempTradingInDirect(AccountName varchar(25),Debit Decimal(18,6),Credit Decimal(18,6),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
Create table #TempTradingEID(AccountName nvarchar(25),Amount Decimal(18,6),SNo Int IDENTITY(1,1),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
Create table #TempTradingIID(AccountName nvarchar(25),Amount Decimal(18,6),SNo Int IDENTITY(1,1),AccountID Int,FromDate datetime,ToDate datetime,DocRef integer,DocType integer,HighLight Int)
...
Select dbo.LookupDictionaryItem('Opening Stock',Default),@Balance,@OPENINGSTOCKGROUP,@FromDate,@ToDate,0,0,@ACCOUNTGROUP -- Opening Stock GroupID
...
Insert #TempTradingID
Select dbo.LookupDictionaryItem('Closing Stock',Default),@Balance,@CLOSINGSTOCKGROUP,@FromDate,@ToDate,0,0,@ACCOUNTGROUP -- Closing Stock GroupID
...
Begin
	...
	from #TempTradingED
	Left Outer Join #TempTradingID on #TempTradingED.SNO = #TempTradingID.SNO
	--where #TempTradingED.SNO *= #TempTradingID.SNO
End
If @ExpenseCount <@IncomeCount 
Begin
	Insert #TempTrading
	...
	#TempTradingID.FromDate,#TempTradingID.ToDate,#TempTradingID.DocRef,#TempTradingID.DocType,#TempTradingID.HighLight
	from #TempTradingED
	Right Outer Join #TempTradingID on #TempTradingED.SNO = #TempTradingID.SNO
...
Declare @DebitTotal Decimal(18,6),@CreditTotal Decimal(18,6),@GrossValue Decimal(18,6)
...
Begin
	...
	from #TempTradingEID
	Left Outer Join #TempTradingIID on #TempTradingEID.SNO = #TempTradingIID.SNO
	--where #TempTradingEID.SNO *= #TempTradingIID.SNO
End
If @ExpenseIDCount <@IncomeIDCount 
Begin
	Insert #TempTrading1
	...
	#TempTradingIID.FromDate,#TempTradingIID.ToDate,#TempTradingIID.DocRef,#TempTradingIID.DocType,#TempTradingIID.HighLight
	from #TempTradingEID
	Right Outer Join #TempTradingIID on #TempTradingEID.SNO = #TempTradingIID.SNO
	--where #TempTradingEID.SNO =* #TempTradingIID.SNO
End
