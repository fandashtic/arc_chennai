CREATE Procedure sp_Save_Salesman    
...
Begin  
	Insert into Salesman(Salesman_Name,Address,ResidentialNumber,MobileNumber,Commission,SalesManCode,CategoryMapping,SkillLevel)
	values(@SalesmanName,@Address,@ResNumber,@MobNumber,@Comission,@Salesmancode1,@CategoryMapping,@SkillLevel)          
	Select @@Identity      
End  
else  
Begin  
