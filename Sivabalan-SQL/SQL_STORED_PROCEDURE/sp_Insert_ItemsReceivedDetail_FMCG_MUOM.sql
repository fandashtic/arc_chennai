CREATE Procedure sp_Insert_ItemsReceivedDetail_FMCG_MUOM (@PartyID int,
...
ParentCategory, Active, UOM1, UOM2, UOM1_Conversion, UOM2_Conversion, DEFAULTUOM, HYPERLINK, VAT, COLLECTTAXSUFFERED,
...
@CategoryPropCount, @ItemPropCount, @CreationDate, @ModifiedDate, @CatParent, @Active,
