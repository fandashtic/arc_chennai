CREATE Procedure sp_acc_gj_arvcancel (@DocumentID INT,@BackDate DATETIME=Null)
AS
...
Begin
	...
	execute sp_acc_insertGJ @TransactionID,@AccountID1,@ARVDate,0,@NetValue,@DocumentID,@AccountType,"ARV Cancellation",@DocumentNumber
...
Begin
	...
	Begin
		...
		Begin
			...
			execute sp_acc_insertGJ @TempTransactionID,@AccountID2,@ARVDate,@Amount,0,@DocumentID,@AccountType,"ARV Cancellation",@TempDocumentNumber
			...
			Begin
				...
				execute sp_acc_insertGJ @TransactionID,@PROFITONSALEOFASSET,@ARVDate,@DiffSaleAssetValue,0,@DocumentID,@AccountType,"ARV Cancellation-Profit",@DocumentNumber
				-- Entry for Asset Account
				execute sp_acc_insertGJ @TransactionID,@AccountID2,@ARVDate,0,@DiffSaleAssetValue,@DocumentID,@AccountType,"ARV Cancellation-Profit",@DocumentNumber
			...
			Begin
				...
				-- Entry for Asset Account				
				execute sp_acc_insertGJ @TransactionID,@AccountID2,@ARVDate,@DiffSaleAssetValue,0,@DocumentID,@AccountType,"ARV Cancellation-Loss",@DocumentNumber
				-- Entry for Loss on Sale of Asset Account
				execute sp_acc_insertGJ @TransactionID,@LOSSONSALEOFASSET,@ARVDate,0,@DiffSaleAssetValue,@DocumentID,@AccountType,"ARV Cancellation-Loss",@DocumentNumber
		...
		Begin
			...
			execute sp_acc_insertGJ @TempTransactionID,@AccountID2,@ARVDate,@Amount,0,@DocumentID,@AccountType,"ARV Cancellation",@TempTransactionID
			Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)
		End
	End
...
Begin
	...
	execute sp_acc_insertGJ @TempTransactionID,@SALESTAXACCOUNT,@ARVDate,@TotalSalesTax,0,@DocumentID,@AccountType,"ARV Cancellation-SalesTax",@TempTransactionID
...
Begin
	...
	Begin
		...
		Begin
			...
			-- Entry for Asset Account	
			execute sp_acc_insertGJ @TransactionID,@AccountID2,@ARVDate,0,@Amount,@DocumentID,@AccountType,"ARV Cancellation-Service Charge",@DocumentNumber
			Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)
		End
		...
		Begin
			...
			-- Entry for Asset Account	
			execute sp_acc_insertGJ @TransactionID,@AccountID2,@ARVDate,0,@Amount,@DocumentID,@AccountType,"ARV Cancellation-ServiceCharge",@DocumentNumber
			Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)
		End
	End
...
Begin
	-- Entry for SalesTax Account
	execute sp_acc_insertGJ @TransactionID,@AccountID1,@ARVDate,@SumServiceChargeAmt,0,@DocumentID,@AccountType,"ARV Cancellation-ServiceCharge",@DocumentNumber
	Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID1)
	Update ARVAbstract Set Balance=IsNull(Balance,0) + IsNull(@SumServiceChargeAmt,0) Where DocumentID=@DocumentID --service charge internally add to balance
End
