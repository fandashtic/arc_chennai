...
Begin
	...
	While @@fetch_status =0
		Begin
			...
			Insert Into @TempUOM
			select Van,Category,Product_Code ItemCode, ProductName ItemName, (Case When (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int)) = 0 Then Null Else (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int))
 End) CFC,
			(Case When Category = 'MT' Then Quantity Else ((Quantity - (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int) * cast(UOM1 as Decimal(18,6)))) / UOM2) End) [Loose Pack] , (Case When Category = 'MT' Then Quantity Else cast((Quantity / UOM2) as Decimal(18,6)) End) [Total Packs] From #temp
...
Else
Begin
	select 1, Van,Category,Product_Code ItemCode, ProductName ItemName, (Case When (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int)) = 0 Then Null Else (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int)
) End) CFC,
	(Case When Category = 'MT' Then Quantity Else ((Quantity - (Cast((cast(Quantity as Decimal(18,6)) / Cast(UOM1 as Decimal(18,6))) as Int) * cast(UOM1 as Decimal(18,6)))) / UOM2) End) [Loose Pack] , (Case When Category = 'MT' Then Quantity Else cast((Quantity / UOM2) as Decimal(18,6)) End) [Total Packs] From #temp
