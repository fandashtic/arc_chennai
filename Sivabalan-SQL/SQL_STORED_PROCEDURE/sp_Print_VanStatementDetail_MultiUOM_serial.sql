CREATE procedure sp_Print_VanStatementDetail_MultiUOM_serial (@DocSerial int)
as
...
Batch_Products.Expiry, VanStatementDetail.SalePrice,VanStatementDetail.transferitemserial
Union All
Select "Item Code"= VanStatementDetail.Product_Code, 
"Item Name"= Items.ProductName, "Batch"= VanStatementDetail.Batch_Number,
"Expiry"= NULL, 
...
Group by VanStatementDetail.Product_Code, Items.ProductName, VanStatementDetail.Batch_Number,VanStatementDetail.TransferItemSerial,
VanStatementDetail.SalePrice,VanStatementDetail.transferitemserial
