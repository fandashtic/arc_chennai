Create Procedure [dbo].[sp_print_InvAbstract_Windows_Exempted_ITC_GST](@INVNO INT)
AS
BEGIN
Set dateformat DMY
...
Select TOP 1 @CompanyState=StateName,@CompanySC=ForumStateCode ,@WDFSSAINO =   Case when Setup.STRegn = '' then '' else 'FSSAI No. : ' + Setup.STRegn End
from StateCode
...
"TotTaxableGV" = Cast(IsNull(0,0) As Decimal(18,2)),
"Rounded Net Value" =
Cast(
