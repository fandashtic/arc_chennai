Create Procedure mERP_sp_Find_SKUSchemeID_New
...
--			 (SKU.SKUCode = @SKUCode Or SKU.SKUCode = 'All') 
	   ...
	   Insert into 	#tmpSchProdScope
	   Select Schemeid,ProductScopeid  from SchemeProducts Where Product_Code = @SKUCode And Active = 1 	 
...
NoValidScheme:		
	Select SchemeID,RecSchemeID,Description,
	SlabType,Min(SlabID) from #tmpSlab 
	Group By SchemeID,RecSchemeID,Description,SlabType
