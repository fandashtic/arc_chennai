CREATE Procedure sp_save_StockAdjustmentOthers_MUOM(@STOCKID INT,          
...
If @TaxType = 0 
Begin
  Select Top 1 @TaxType  = IsNull(TaxType,1) from Batch_Products Where Product_Code = @ITEM_CODE And Batch_Number = @BATCH_NUMBER Order by Batch_Code Desc
End
...
BEGIN          
 ...
 @MRPPERPACK = IsNull(MRPPERPACK,0)
 ...
 UOMQty, UOMPrice, Free, GRNTaxSuffered, GRNTaxID, GRNApplicableOn, GRNPartOff, ApplicableOn, PartofPercentage, Vat_Locality, 
 DocType, DocId, TaxType, MRPPerPack)          
 ...
 ABS(@ADJUSTMENT_QTY), @ADJUSTMENT_PRICE, @Free, @GRNTaxSuffered, @GRNTaxId, @GRNApplicableOn, @GRNPartOff, @ApplicableOn, @PartOff,
  @Vat_Locality, 2, @STOCKID, @TaxType,@MRPPERPACK)          
...
Begin      
 ...
 Update Batch_Products Set DocID = @STOCKID, QuantityReceived=@NEW_QTY, PTR = @MarginPTRValue 
