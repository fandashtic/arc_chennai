...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_ASL_KL](@INVNO INT)     
AS    
Set dateformat DMY      
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_KL  @INVNO,1
--Select  1
...
"TaxBrkUp" = dbo.GetTaxCompInfoForInv(@INVNO, 1, 1),--cast(IsNull(TotalTaxApplicable,0) as decimal(18,2)),
