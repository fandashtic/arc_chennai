CREATE procedure sp_acc_rpt_total_outstanding(@fromdate datetime,@todate datetime)
as
...
select 0, "Total OutStanding" = @total, "1-7 Days" = @OnetoSeven,
