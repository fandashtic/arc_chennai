CREATE procedure [dbo].[spr_customerwise_sales_pidilite](@Customer nvarchar(2550), @FROMDATE datetime,  
     @TODATE datetime,  
     @CusType nvarchar(50))  
AS  
...
Customer.Company_Name In (Select Customer COLLATE SQL_Latin1_General_CP1_CI_AS From #tmpCustomer)
...
Select Case Isnull(InvoiceAbstract.CustomerID, N'') When N'' Then N'Others' Else InvoiceAbstract.CustomerID End,  
"CustomerID" = Case Isnull(InvoiceAbstract.CustomerID, N'') When N'' Then N'Others' Else InvoiceAbstract.CustomerID End,  
"Customer" = Case isnull(Customer.Company_Name, N'') When N'' Then N'Others' Else Customer.Company_Name End,  
