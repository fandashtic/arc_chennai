CREATE procedure [dbo].[sp_Print_PurchaseRetDetailMUOM_serial] (@AdjustmentID int)
as
Select 
...
From AdjustmentReturnDetail, Items, Batch_Products, StockAdjustmentReason, ItemCategories, uom
...
AdjustmentReturnDetail.BillID, AdjustmentReturnDetail.Tax,AdjustmentReturnDetail.serialno
