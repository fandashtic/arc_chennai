CREATE Procedure sp_Insert_ConversionDetail (	@DocSerial int,
...
Begin
   ...
   From Batch_Products 
	Where Batch_Code = (Select BatchReference From Batch_Products 
	Where Batch_Code = @OldBatchCode)
	Set @Free = 0
End
...
Select 				Batch_Number,
				...
				@Free,
				StockTransferID,
				@OldBatchCode, GRN_ID, @TaxSuffered, @ApplicableOn, @PartOff 
