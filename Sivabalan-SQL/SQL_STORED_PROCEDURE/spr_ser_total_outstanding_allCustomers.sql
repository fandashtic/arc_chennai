CREATE procedure spr_ser_total_outstanding_allCustomers(@Dummy int,@FromDate datetime,@ToDate datetime)
as
...
select ServiceInvoiceAbstract.CustomerID,
	count(ServiceInvoiceID), 
	sum(isnull(ServiceInvoiceAbstract.Balance, 0)) ,
(Select Sum(IsNull(SInv.Balance, 0)) 
From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Seven And @One And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0),

(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Ten And @Eight And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Fourteen And @Eleven And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 128 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @TwentyOne And @Fifteen And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Thirty And @TwentyTwo And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate > @Thirty And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0 ),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Sixty And @ThirtyOne And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
Isnull(SInv.Status,0) & 192 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate Between @Ninety And @SixtyOne And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
ISnull(SInv.Status,0) & 192 = 0),
(Select Sum(IsNull(SInv.Balance, 0)) From ServiceInvoiceAbstract As SInv
Where SInv.CustomerID = ServiceInvoiceAbstract.CustomerID And
SInv.ServiceInvoiceDate < @Ninety And
SInv.Balance > 0 And
SInv.ServiceInvoiceType In (1) And
ISnull(SInv.Status,0) & 192 = 0)
