CREATE Procedure sp_acc_rpt_tradingacrecursivebalance_FundsFlow(@parentid integer,@fromdate datetime, @todate datetime,@GetOpeningBalance integer,@balance decimal(18,6) output,@TotalDepAmt decimal(18,6) = 0 output)          
as          
...
Begin          
  ...
  Else If @AccountID = @CLOSINGSTOCK          
   Begin          
   if @GetOpeningBalance = 0 -- get closing balance  
    Begin  
