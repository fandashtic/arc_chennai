...
CREATE Procedure sp_save_invoice_detail_CSP_van_pharma(@INVOICE_ID int,  
...
BEGIN  
 ...
 TaxSuffered, TaxSuffered2, PTS, PTR)  
...
IF @TRACK_BATCHES = 1  
 ...
 IF @CUSTOMERTYPE = 1  
  ...
  ISNULL(VanStatementDetail.PTS, 0) = @MODIFIED_PRICE And ISNULL(Batch_Products.Free,0) = @FreeRow  
  ...
  ISNULL(VanStatementDetail.PTS, 0) = @MODIFIED_PRICE AND ISNULL(Pending, 0) > 0 And ISNULL(Batch_Products.Free,0) = @FreeRow  
  END  
 ELSE IF @CUSTOMERTYPE = 2  
  ...
  DocSerial = @VANSTMTID AND VanStatementDetail.Product_Code = @ITEM_CODE   
  AND ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER AND   
  ISNULL(VanStatementDetail.PTR, 0) = @MODIFIED_PRICE And ISNULL(Batch_Products.Free,0) = @FreeRow  
  ...
  WHERE DocSerial = @VANSTMTID and VanStatementDetail.Product_Code = @ITEM_CODE and   
  ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER and   
  ISNULL(VanStatementDetail.PTR, 0) = @MODIFIED_PRICE AND ISNULL(Pending, 0) > 0 And ISNULL(Batch_Products.Free,0) = @FreeRow  
  END  
 ELSE IF @CUSTOMERTYPE = 3  
  ...
  DocSerial = @VANSTMTID AND VanStatementDetail.Product_Code = @ITEM_CODE   
  AND ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER AND   
  ISNULL(VanStatementDetail.SpecialPrice, 0) = @MODIFIED_PRICE And ISNULL(Batch_Products.Free,0) = @FreeRow  
  ...
  DocSerial = @VANSTMTID and VanStatementDetail.Product_Code = @ITEM_CODE and   
  ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER and   
  ISNULL(VanStatementDetail.SpecialPrice, 0) = @MODIFIED_PRICE AND ISNULL(Pending, 0) > 0 And ISNULL(Batch_Products.Free,0) = @FreeRow  
  END  
 ELSE  
  BEGIN  
  SELECT @TOTAL_QUANTITY = ISNULL(SUM(Pending), 0) FROM VanStatementDetail, Batch_Products  
  ...
  DocSerial = @VANSTMTID AND VanStatementDetail.Product_Code = @ITEM_CODE   
  AND ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER AND   
  ISNULL(VanStatementDetail.SalePrice, 0) = @MODIFIED_PRICE And ISNULL(Batch_Products.Free,0) = @FreeRow  
  ...
  WHERE DocSerial = @VANSTMTID and VanStatementDetail.Product_Code = @ITEM_CODE and   
  ISNULL(VanStatementDetail.Batch_Number, N'') = @BATCH_NUMBER and   
  ISNULL(VanStatementDetail.SalePrice, 0) = @MODIFIED_PRICE AND ISNULL(Pending, 0) > 0 And ISNULL(Batch_Products.Free,0) = @FreeRow  
  END  
 END  
ELSE  
 BEGIN  
 IF @CUSTOMERTYPE = 1  
  ...
  WHERE VanStatementDetail.Batch_Code = Batch_Products.Batch_Code And  
  DocSerial = @VANSTMTID and VanStatementDetail.Product_Code = @ITEM_CODE AND   
  ISNULL(VanStatementDetail.PTS, 0) = @MODIFIED_PRICE  
...
BEGIN  
 ...
 @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2, @PTS, @PTR)  
 ...
 @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2, @PTS, @PTR)  
 SET @TAXCODE = 0  
