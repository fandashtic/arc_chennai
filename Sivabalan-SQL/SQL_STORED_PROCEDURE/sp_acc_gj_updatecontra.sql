CREATE procedure sp_acc_gj_updatecontra(@contraid integer,@BackDate DATETIME=Null)        
as        
...
begin        
 ...
 Values(@documentid,@accountid,@depositdate,@value,0,@contraid,@DOCTYPE,'Cash deposited in bank',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@accountid)        
         
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@CASH,@depositdate,0,@value,@contraid,@DOCTYPE,'Cash deposited in bank',@uniqueid)          
...
begin        
 ...
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@CASH,@depositdate,@value,0,@contraid,@DOCTYPE,'Cash withdrawl from bank',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@CASH)        
         
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@accountid,@depositdate,0,@value,@contraid,@DOCTYPE,'Cash withdrawl from bank',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@accountid)        
end        
...
begin        
 ...
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@PETTYCASH,@depositdate,@value,0,@contraid,@DOCTYPE,'Cash paid to petty cash',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@PETTYCASH)        
        
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])   
 Values(@documentid,@CASH,@depositdate,0,@value,@contraid,@DOCTYPE,'Cash paid to petty cash',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@CASH)        
end        
...
begin        
 ...
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@CASH,@depositdate,@value,0,@contraid,@DOCTYPE,'Cash receieved from petty cash',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@CASH)        
        
 insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
 [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
 Values(@documentid,@PETTYCASH,@depositdate,0,@value,@contraid,@DOCTYPE,'Cash receieved from petty cash',@uniqueid)          
 Insert Into #TempBackdatedContra(AccountID) Values(@PETTYCASH)        
end        
 ...
 begin        
  ...
  insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
  [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
  Values(@documentid,isnull(@ToAccountID,0),@depositdate,@value,0,@contraid,@DOCTYPE,'Internal Bank Transfer',@uniqueid)          
  Insert Into #TempBackdatedContra(AccountID) Values(@ToAccountID)        
        
  insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],        
  [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])        
  Values(@documentid,@accountid,@depositdate,0,@value,@contraid,@DOCTYPE,'Internal Bank Transfer',@uniqueid)          
  Insert Into #TempBackdatedContra(AccountID) Values(@accountid)        
 end      
