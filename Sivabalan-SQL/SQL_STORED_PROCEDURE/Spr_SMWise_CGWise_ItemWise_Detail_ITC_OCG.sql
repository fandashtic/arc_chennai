Create Procedure Spr_SMWise_CGWise_ItemWise_Detail_ITC_OCG          
(          
 @Dummy NVarChar(4000),
...
select @CGType = allname from #Temp where allID=4
          
Insert InTo #TmpGroup Select GroupID From ProductCategoryGroupAbstract 
Where GroupName In (Select AllName From #Temp Where AllID = 3)          
