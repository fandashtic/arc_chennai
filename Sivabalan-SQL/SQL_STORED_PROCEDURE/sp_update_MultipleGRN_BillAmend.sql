CREATE procedure sp_update_MultipleGRN_BillAmend(
		@Old_Bill int, 
...
as      
Declare @GRN_ID as nvarchar(255)      
Declare @NewGRN_ID as nvarchar(255)      
...
ExciseDuty, DiscountBeforeExcise, PurchasePriceBeforeExcise,VATTaxAmount) Values      
