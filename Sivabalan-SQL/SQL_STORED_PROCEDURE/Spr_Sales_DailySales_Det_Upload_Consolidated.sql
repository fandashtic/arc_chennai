CREATE procedure [dbo].[Spr_Sales_DailySales_Det_Upload_Consolidated](@Salesmanid nvarchar(30), @SalesDate DateTime, @Unused1 nVarchar(30),@Unused2 nVarchar(30))                     
As                                  
...
Select @ComIDReport = Right(@Salesmanid,(Select Len(RegisteredOwner) From Setup))  
...
Select @Salesmanid = Left(@Salesmanid,Len(@Salesmanid)-(Select Len(RegisteredOwner) From Setup))  
                                
Create Table #TmpDailyDet ( CustomerId nVarchar(15) collate SQL_Latin1_General_CP1_CI_AS, [Cust ID] nVarchar(15) collate SQL_Latin1_General_CP1_CI_AS,  
[Cust Name] nVarchar(150) collate SQL_Latin1_General_CP1_CI_AS, Channel nvarchar(255) collate SQL_Latin1_General_CP1_CI_AS, [Sub Channel] nVarchar(100) collate SQL_Latin1_General_CP1_CI_AS,                                    
[Visited Y/N] nVarchar(10) collate SQL_Latin1_General_CP1_CI_AS, Inventory Decimal(18,6), [Customer Purchase During Last 2 Visits] Decimal(18,6),[Inventory During Last SV] Decimal(18,6),                     
...
Select   
'',  
"Cust Id" = ReportDetailReceived.Field1,  
"Cust Name" = ReportDetailReceived.Field2,  
"Channel" = ReportDetailReceived.Field3,  
"Sub Channel" = ReportDetailReceived.Field4,  
"Visited Y/N" = ReportDetailReceived.Field5,  
"Inventory" = ReportDetailReceived.Field6,  
"Customer Purchase During Last 2 Visits" = ReportDetailReceived.Field7,  
"Inventory During Last SV" = ReportDetailReceived.Field8,  
"Customer Sales During Last 2 Visits" = ReportDetailReceived.Field9,  
"OffTake" = ReportDetailReceived.Field10,  
"Suggested Order" = ReportDetailReceived.Field11,  
"Actual Order" = ReportDetailReceived.Field12,  
"Volume Objective This Month" = ReportDetailReceived.Field13,  
"Volume Till Date" = ReportDetailReceived.Field14,  
"Ohd Pre" = ReportDetailReceived.Field15,  
"MDSG Sip Objective" = ReportDetailReceived.Field16,  
"MDSG Sip" = ReportDetailReceived.Field17,  
"MDSG Pos Objective" = ReportDetailReceived.Field18,  
"MDSG Pos" = ReportDetailReceived.Field19  
From ReportDetailReceived  
Where   
ReportDetailReceived.Field1 <> N'Cust Id' And ReportDetailReceived.Field1 <> N'SubTotal:' And  
ReportDetailReceived.Field1 <> N'GrandTotal:' And ReportDetailReceived.RecordID = @Salesmanid   
End
