--exec [sp_print_RetInvItems_RespectiveUOM_CIG_IGST_ITC_GST_Siva] 416224
CREATE procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_CIG_IGST_ITC_GST_Siva](@INVNO INT,@MODE INT=0)
AS
Begin
