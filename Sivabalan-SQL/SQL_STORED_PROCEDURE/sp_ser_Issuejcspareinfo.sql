CREATE procedure sp_ser_Issuejcspareinfo(@customerID nvarchar(50),   
...
'SalePrice' = IsNull(dbo.sp_ser_getspareprice(@CustomerType,j.SpareCode),0),  
...
'UOMPrice' = IsNull(dbo.sp_ser_getuomprice(j.SpareCode,i.UOM,@CustomerType),0),  
