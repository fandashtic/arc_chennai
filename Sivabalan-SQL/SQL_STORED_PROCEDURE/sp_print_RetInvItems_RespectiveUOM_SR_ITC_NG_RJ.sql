...
Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_RJ](@INVNO INT,@MODE INT = 0)          
AS  
Begin  
...
CREATE TABLE #TmpInvDet(
	[id1] [int] IDENTITY(1,1),
	[Quantity] decimal(18, 2),
	[Free] decimal(18, 2),
	[UOM] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Sale Price] nvarchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[TaxDetails] nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[TaxDetailsWithBreakup] nvarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Discount%] decimal(18, 6),
	[Discount Value] decimal(18, 6),
	[Amount] nvarchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Description] nvarchar(Max) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Item Gross Value] nvarchar(30) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Net Value] decimal(38, 6),
	[Net Amount] decimal(18, 6),
	[Item MRP] decimal(18, 6) ,
	[Serial] [int],
	[Batch.No] nvarchar(9) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Mrf.Dt.] nvarchar(7) COLLATE SQL_Latin1_General_CP1_CI_AS,
	[Exp.Dt.] nvarchar(7) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)
