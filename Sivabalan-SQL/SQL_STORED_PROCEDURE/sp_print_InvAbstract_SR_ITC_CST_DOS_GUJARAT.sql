...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_CST_DOS_GUJARAT](@INVNO INT)     
AS  
Set dateformat DMY        
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_GUJARAT @INVNO,1
--Select  1
...
"TaxDetailsWithBreakup" = Replace(dbo.GetTaxDetailsWithBreakup_CST_DOS (@INVNO),';',Char(13)), 
...
"TaxBrkUp" = dbo.GetTaxCompInfoForInv_CST(@INVNO, 1, 1),
"CompBrkUp" = '',--dbo.GetTaxCompInfoForInv_CST(@INVNO, 2, 1),
"TotTax" = dbo.GetTaxCompInfoForInv_CST(@INVNO, 1, 2),
