...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_HP](@INVNO INT)     
AS      
Set dateformat DMY    
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_HP @INVNO,1
...
"TAX HEADING" = 'T A X   I N V O I C E', 
"TAX INVOICE COPY" = 'Original Copy/Second Copy/Last Copy', 
"TAX DISCLAIMER TEXT" = 'Original copy "Input Tax Credit is available to a registered dealer against this copy" ' + 
					'Second copy "This copy does not entitle the holder to claim input tax credit"' +
					Replicate(' ', (91 - Len('Second copy "This copy does not entitle the holder to claim input tax credit"'))) +
					'Last copy shall be retained by the seller' +
					Replicate(' ', (70)),
