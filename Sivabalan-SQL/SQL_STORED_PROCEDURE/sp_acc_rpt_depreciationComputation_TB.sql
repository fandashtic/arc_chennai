CREATE procedure sp_acc_rpt_depreciationComputation_TB(@FromDate datetime,@ToDate datetime,@FixedAssetGroup Int,@DepreciationValue Decimal(18,6) Output)    
As    
