CREATE Procedure [dbo].[spr_list_Sales_VAT_Report]   
(       
@From_Date DateTime,       
@To_Date DateTime      
 )      
...
Create Table #SalesVAT (DocType nvarchar(5) COLLATE SQL_Latin1_General_CP1_CI_AS, TempDocID Integer, DocuDate DateTime, DocuID nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS, DocRef nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS, Cust_Name nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS, NetValue Decimal(18,6))    
...
--Set @SelectSQL = 'Select DocuDate, ''Document Date'' = DocuDate, ''Document ID '' = DocuID , ''Document Ref'' = DocRef, ''Customer/Branch'' = Cust_Name, NetValue,' + @Field_Str + ' From  #SalesVAT'
--print @Field_Str    
--Select * from #salesvat
exec (N'Select DocuDate, ''Document Date'' = DocuDate, ''Document ID '' = DocuID , ''Document Ref'' = DocRef, ''Customer/Branch'' = Cust_Name, NetValue' + @Field_Str + @Field_Str1+@Field_Str2+@Field_Str3+ ' From  #SalesVAT')    
Drop Table #SalesVAT    
