CREATE Procedure [dbo].[FSU_sp_InsertThinserverInstallationDetail_Miss_Check]   
As  
begin  
...
from tblReleaseDetail RD   
 ...
 where RD.Status & 2 = 2   
 And RD.status & 444= 0  
--commented because more than once record should be inserted in CHECK and MISSING case
