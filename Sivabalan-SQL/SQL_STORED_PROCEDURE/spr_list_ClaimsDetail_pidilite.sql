CREATE PROCEDURE spr_list_ClaimsDetail_pidilite (@CLAIMID INT)  
...
if @nClaimType = 6 
Select "Invoice No" = ClaimsDetail.InvoiceID, 
"Document No" = @InvPrefix + Cast(DocumentID as nvarchar), 
"Invoice Date" = InvoiceDate, 
"Sales Value" = NetValue,  
"Scheme Discount" = SchemeDiscountAmount, 
...
ClaimsDetail.Quantity, 
"Reporting UOM" = ClaimsDetail.Quantity / Case IsNull(ReportingUnit, 1) When 0 Then 1 Else IsNull(ReportingUnit, 1) End,  
"Conversion Factor" = ClaimsDetail.Quantity * IsNull(ConversionFactor, 0),  
ClaimsDetail.Rate,   
