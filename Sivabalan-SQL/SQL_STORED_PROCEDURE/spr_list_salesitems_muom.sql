CREATE procedure [dbo].[spr_list_salesitems_muom](@Manufacturer nvarchar(2550), 
...
Left Outer Join UOM on (Case @UOM When 'Sales UOM' Then Items.UOM When 'UOM1' Then Items.UOM1 
               When 'UOM2' Then Items.UOM2 End) = UOM.UOM
Inner Join ConversionTable on Items.ConversionUnit = ConversionTable.ConversionID

where 
--#temp.product_code collate SQL_Latin1_General_Cp1_CI_AS = items.product_code and 
#temp.SaleID = 1 
