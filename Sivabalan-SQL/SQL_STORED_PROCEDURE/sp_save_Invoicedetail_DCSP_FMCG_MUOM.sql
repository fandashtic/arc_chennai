CREATE procedure [dbo].[sp_save_Invoicedetail_DCSP_FMCG_MUOM](@INVOICE_ID int,
...
SELECT @SALEID = SaleID, @COST = Purchase_Price, @MRP = MRP, @PRICEOPTION = Price_Option FROM Items, ItemCategories
