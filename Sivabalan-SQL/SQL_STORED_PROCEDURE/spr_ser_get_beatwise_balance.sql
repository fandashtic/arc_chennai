CREATE PROCEDURE spr_ser_get_beatwise_balance    
...
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
...
- Isnull(    
  (select sum(Balance) From Creditnote,Customer where      
   ...
   CreditNote.CustomerID Is Not Null  And CreditNote.CustomerID <> ''    
...
--Debitnote.Documentdate between @FROMDATE AND @TODATE And     
  DebitNote.CustomerID Is Not Null And DebitNote.CustomerID <> ''    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Seven AND @One and    
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Ten AND @Eight and  
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Fourteen AND @Eleven and    
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @TwentyOne AND @Fifteen and    
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Thirty AND @TwentyTwo and    
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact 
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate > @Thirty and  
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Sixty And @ThirtyOne and 
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @Ninety And @SixtyOne and
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
...
--Begin:Service Invoice Impact
+ (isNull((select sum(isNull(Balance,0)) from ServiceInvoiceAbstract SI where 
SI.ServiceInvoiceDate between @OpeningDate And @Ninety and
#tempbeat.BeatID = 0 and SI.ServiceInvoiceType in (1) and (isNUll(SI.Status,0) & 192) = 0),0))
--End:Service Invoice Impact    
