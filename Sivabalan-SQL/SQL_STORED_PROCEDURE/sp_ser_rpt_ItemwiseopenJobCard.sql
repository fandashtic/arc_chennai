CREATE Procedure sp_ser_rpt_ItemwiseopenJobCard(@ITEM nvarchar(255))              
AS              
...
jobname 'Description', 'ColumnKey' = 0
from Jobcarddetail             
...
[description] 'Description', 'ColumnKey' = 0
from Jobcarddetail        
...
(case Type when 1 then 'Job' when 2 then 'Task' when 3 then 'Spare' else '' end) as 'Type',        
--sparecode 'Type',          
productname 'Description', 'ColumnKey' = 0
from jobcarddetail             
