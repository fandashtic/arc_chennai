CREATE Procedure sp_save_invoice_detail_CSP_van(@INVOICE_ID int,
...
BEGIN
	...
	TaxCode, DiscountPercentage, DiscountValue, Amount, PurchasePrice, STPayable, MRP, TaxID, FlagWord, SaleID, TaxCode2, CSTPayable, TaxSuffered, TaxSuffered2)
	VALUES (@INVOICE_ID, @ITEM_CODE, @ROWID, @BATCH_NUMBER, @REQUIRED_QUANTITY, @MODIFIED_PRICE, @TAXCODE, 
	@DISCOUNTPERCENTAGE, @DISCOUNTAMOUNT, @AMOUNT, @REQUIRED_QUANTITY * @COST, @STPAYABLE, @MRP, @TAXID, @FLAG, @SALEID, @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2)
	...
	SalePrice, TaxCode, DiscountPercentage, DiscountValue, Amount, PurchasePrice, STPayable, MRP, TaxID, FlagWord, SaleID, TaxCode2, CSTPayable, TaxSuffered, TaxSuffered2)
	VALUES (@INVOICE_ID, @ITEM_CODE, @ROWID, @BATCH_NUMBER, @QUANTITY, @MODIFIED_PRICE, @TAXCODE, 
	@DISCOUNTPERCENTAGE, @DISCOUNTAMOUNT, @AMOUNT, @COST * @QUANTITY, @STPAYABLE, @MRP, @TAXID, @FLAG, @SALEID, @TAXCODE2, @CSTPAYABLE, @TAXSUFFERED, @TAXSUFFERED2)
	SET @TAXCODE = 0
