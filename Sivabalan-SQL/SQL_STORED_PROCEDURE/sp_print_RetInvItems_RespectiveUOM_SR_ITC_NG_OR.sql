Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_OR](@INVNO INT,@MODE INT = 0)
AS
Begin
...
Into #TmpInvDet
FROM
InvoiceAbstract,InvoiceDetail,UOM,Items,Batch_Products,Manufacturer,
...
InvoiceDetail.UOM, Items.Soldas,InvoiceDetail.Batch_Number,Batch_Products.PKD,Batch_Products.Expiry
Order By Serial
