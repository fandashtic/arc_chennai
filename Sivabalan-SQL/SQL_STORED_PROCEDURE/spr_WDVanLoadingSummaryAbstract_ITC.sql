...
Create Procedure spr_WDVanLoadingSummaryAbstract_ITC( @VanNo nVarchar(4000),  
...
Else          
 Insert into #tmpVan      
 Select Van From Van where Van in (Select * From dbo.sp_SplitIn2Rows(@VanNo,@Delimeter))                      
