Create procedure mERP_sp_list_ProcessedSchemes(@SchemeCode nVarChar(50), @FromDate DateTime, @ToDate DateTime, @FILTER INT = 0)
As
...
Where
 CSAbstract.SchemeType in (1,2) 
 -- and CSAbstract.ActiveFrom Between @FromDate And @ToDate 
...
And		((@FromDate Between CSAbstract.ViewDate And CSAbstract.SchemeTo)  Or 
  ...
  And CSType.ID  = CSAbstract.SchemeType And
