CREATE Procedure Spr_Distributor_Detail ( @ItemCode nVarchar(30),@Category nvarchar(30), @Channel nvarchar(30), @Uom nVarchar(50), @FromDate Datetime, @Todate DateTime)           
As              
