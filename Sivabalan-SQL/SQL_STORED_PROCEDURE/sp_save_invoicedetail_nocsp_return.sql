CREATE Procedure sp_save_invoicedetail_nocsp_return(@INVOICE_ID int,  
...
BEGIN  
	...
	ELSE  
		...
		PKD, TaxSuffered,DocType, DocID) VALUES(@ITEM_CODE, @BATCH_NUMBER, @EXPIRY, @REQUIRED_QUANTITY, @PURCHASEPRICE,   
