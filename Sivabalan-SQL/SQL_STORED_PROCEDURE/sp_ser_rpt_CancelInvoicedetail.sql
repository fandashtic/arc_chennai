CREATE procedure sp_ser_rpt_CancelInvoicedetail(@ServiceInvoiceID int)                              
as                               
...
Create table #ServiceInvoiceCancelDetail_Temp([_ID] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS)
                              
set @Iteminfo =  'Alter table #ServiceInvoiceCancelDetail_Temp Add 
...
Insert into #ServiceInvoiceCancelDetail_Temp        
...
[_Type] as "Type",
[_Amount] as "Amount",
[_Net Value] as "Net Value"
From #ServiceInvoiceCancelDetail_Temp'     

Exec Sp_executesql @Iteminfo1
       
Drop Table #ServiceInvoiceCancelDetail_Temp    
