CREATE procedure [dbo].[spr_list_Invoicewise_Collection_Detail] (@InvoiceID int)    
As
...
DocReference, "Date" = Collections.DocumentDate, 
...
CollectionDetail.DocumentType In (1,4) And     
