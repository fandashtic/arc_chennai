CREATE PROCEDURE [dbo].[sp_acc_rpt_dispatchdetail](@DISPATCHID int)
AS
...
Begin
	Exec sp_acc_rpt_dispatchdetailUOM @DISPATCHID
End
Else If @Version = 9 or @Version = 10
Begin
	Exec sp_acc_rpt_dispatchdetailSerial @DISPATCHID
End
Else
Begin
