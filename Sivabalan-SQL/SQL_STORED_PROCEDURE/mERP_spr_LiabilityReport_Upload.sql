Create Procedure mERP_spr_LiabilityReport_Upload(@FromDate DateTime,@ToDate Datetime)
As
Begin
	...
	Select * Into #tmp_SchemePayoutPeriod From tbl_mERP_SchemePayoutPeriod
	...
	From tbl_mERP_SchemeAbstract SA,  #tmp_SchemePayoutPeriod SPP  
	Where SA.Active = 1
	...
	dbo.StripTimeFromDate(SA.ActiveFrom),dbo.StripTimeFromDate(SA.ActiveTo),
	dbo.StripTimeFromDate(SPP.PayoutPeriodFrom),dbo.StripTimeFromDate(SPP.PayoutPeriodTo)
	From tbl_mERP_SchemeAbstract SA, (select Distinct SchemeId, QPS  From tbl_mERP_SchemeOutlet) SO, #tmp_SchemePayoutPeriod SPP  
...
--	/* To check whether All QPS Credit Note generated */
	If Exists(Select ID From #tmp_SchemePayoutPeriod Where Active=1 and isNull(status,0) <> 128 
	...
	Begin
		...
		Begin
			...
			Begin
				...
				SaleQty, SaleValue
				From tbl_merp_NonQPSData NQD, #tmp_SchemePayoutPeriod SPP 
...
--
	...
	From #tmpSchemeSale SS ,tbl_mERP_SchemeAbstract SA,#tmp_SchemePayoutPeriod SPP
