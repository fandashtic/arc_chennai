CREATE procedure [dbo].[sp_print_RetInvItems_MultiUOM_Serial_Template_Pidilite](@INVNO INT)          
AS          
...
SELECT "Item Code" = InvoiceDetail.Product_Code, "Item Name" = Items.ProductName,           
 ...
 "Free Qty" = (Select Sum(InvDet.Quantity)   
    ...
    And InvDet.Product_Code = InvoiceDetail.Product_Code and FlagWord = 1  
    And invdet.serial = invoicedetail.freeserial),  
 ...
 And (InvoiceDetail.FlagWord = 0  or isnull(invoicedetail.freeserial,0) = 0)
 ...
 InvoiceDetail.ExciseDuty , InvoiceDetail.freeserial     
...
Delete From #tmpInvoice  Where [Sale Price]=N'Free' and   
 ...
 tmpA.Uom2Quantity = 0 and  tmpA.Uom1Quantity = 0 and tmpa.[item code] = #tmpinvoice.[item code]),0) = 1    
  
--Update #tmpInvoice Set UOMQuantity = Null ,[Sale Price]=Null Where [Sale Price]=N'Free'          
