CREATE Procedure Spr_Purchase_Batch_Movement_NoUOM_pidilite  
...
Select i.Product_Code,       
  ...
  "Reporting Unit" = (IsNull([Purchase], 0) - IsNull([Purchase Return], 0)) / Case IsNull(ReportingUnit, 1) When 0 Then 1 Else IsNull(ReportingUnit, 1) End,    
