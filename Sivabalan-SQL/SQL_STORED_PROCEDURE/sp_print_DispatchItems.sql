CREATE PROCEDURE [dbo].[sp_print_DispatchItems](@DISPATCHID INT)
AS
...
Max(Items.PTR) 
END,
"ECP" = CASE ItemCategories.Price_Option 
WHEN 1 THEN
...
Right Outer Join Customer on Customer.CustomerID = DispatchAbstract.CustomerID 
