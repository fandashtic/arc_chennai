CREATE Procedure [dbo].[sp_view_DSwiseBeatwiseCollectionDetail](@CollectionID as int)          
as          
...
where cl.DocumentID in (Select DocumentID From InvoicewiseCollectionDetail Where CollectionID=@CollectionID)
