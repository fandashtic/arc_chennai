CREATE procedure sp_list_Vendor_DebitNote_DocLU (@FromDocID int,    
...
Begin  
 select DocumentID, DocumentDate, Vendors.VendorID, Vendors.Vendor_Name, NoteValue,    
 DebitID,    
 case     
 ...
 and  Vendors.VendorID = DebitNote.VendorID    
