...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_Windows_UT_CG](@INVNO INT)     
AS       
Set dateformat DMY   
...
"TaxPercentage" =  dbo.GetTaxDetails_windows_UT_NTD(@INVNO,1),
"SalesValue" = dbo.GetTaxDetails_windows_UT_NTD(@INVNO,2),
--"TaxCompPercentage" =  dbo.GetTaxDetails_windows(@INVNO,3),
"TaxAmt" =  dbo.GetTaxDetails_windows_UT_NTD(@INVNO,4),
"TotalTaxAmt" =  dbo.GetTaxDetails_windows_UT_NTD(@INVNO,5),
