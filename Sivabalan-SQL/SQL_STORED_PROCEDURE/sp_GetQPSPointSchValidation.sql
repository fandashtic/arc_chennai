Create Procedure sp_GetQPSPointSchValidation(@SchemeId Int, @PayoutID Int,@CustomerID Nvarchar(255))  
As    
Begin
	...
	Select Product_Code,BaseUOMQty,Amount from tbl_mERP_CSOutletPointDetail Where SchemeID = @SchemeId And PayoutID = @PayoutID And OutletCode = @CustomerID
