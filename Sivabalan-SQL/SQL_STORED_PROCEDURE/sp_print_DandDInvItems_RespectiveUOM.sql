Create Procedure [dbo].[sp_print_DandDInvItems_RespectiveUOM](@DnDID INT,@MODE INT=0)
AS
Begin
...
Then Cast(cast(DD.UOMPTS As Decimal(18,2)) as nvarchar) End,''),
...
End As Decimal(18,2) )as nvarchar),'') Else '' End,
