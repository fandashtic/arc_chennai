CREATE Procedure sp_acc_gj_AmendmentOtherPayments(@PaymentID INT,@BackDate DateTime=NULL)  
As  
DECLARE @PartyID INT  
...
Begin  
 ...
 Begin  
  ...
  Begin  
			...
			Values(@DocumentID,@PartyID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Cash Payment-Amendment',@UniqueID)    
			Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@PartyID)  
			
			Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
			Values(@DocumentID,@CASH,@PaymentDate,0,@Value,@PaymentID,@DOCUMENTTYPE,'Cash Payment-Amendment',@UniqueID)    
 ...
 Begin  
  ...
  /*to check whether the cheque is a current date cheque Or postdated cheque*/   
		If (dbo.StripDateFromTime(@PaymentDate)<@CurrentDate) And (dbo.StripDateFromTime(@PaymentDate)<@ChequeDate) And  (@ChequeDate<=@CurrentDate)  
		Begin  
			If @Value<>0  
			Begin  
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@PartyID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
				Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@PartyID)  
			End  
			If @Value<>0  
			Begin   
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@POSTDATEDCHEQUE,@PaymentDate,0,@Value,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
   ...
   Commit Tran  
			...
			Begin  
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@POSTDATEDCHEQUE,@ChequeDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
				Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@POSTDATEDCHEQUE)  
			End  
			If @Value<>0  
			Begin   
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@BankAccount,@ChequeDate,0,@Value,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
				Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@BankAccount)  
			End  
		End     
		Else If @ChequeDate=@CurrentDate Or @ChequeDate<@CurrentDate  
		Begin  
   If @Value<>0  
   Begin  
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@PartyID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Current Date Cheque Payment-Amendment',@UniqueID)  
				Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@PartyID)  
				
				Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
				[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
				Values(@DocumentID,@BankAccount,@PaymentDate,0,@Value,@PaymentID,@DOCUMENTTYPE,'Current Date Cheque Payment-Amendment',@UniqueID)  
				Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@BankAccount)  
   End  
  End  
 ...
 Begin  
  ...
  Begin  
   Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
   [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
   Values(@DocumentID,@BANKCHARGES,@PaymentDate,@DDCharges,0,@PaymentID,@DOCUMENTTYPE,'DD Payment Amendment-DD Charges',@UniqueID)  
  ...
  Begin   
   Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
   [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
   Values(@DocumentID,@BankAccount,@PaymentDate,0,@DDCharges,@PaymentID,@DOCUMENTTYPE,'DD Payment Amendment-DD Charges',@UniqueID)  
   Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@BankAccount)  
  End   
 End   
 ...
 Begin  
		Select @BankAccount=IsNULL([AccountID],0) from bank  
		Where [BankID]=@BankID     
		Set @Narration='Bank Transfer Payment-Amendment'
		If @Value<>0  
		Begin  
			Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
			[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
 ...
 Begin  
		Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
		[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
		Values(@DocumentID,@OTHERCHARGES,@PaymentDate,@ExtraCol,0,@PaymentID,@DOCUMENTTYPE,'Extra Amount Paid-Amendment',@UniqueID)  
		Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@OTHERCHARGES)  
		
		Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
		[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
		Values(@DocumentID,@PartyID,@PaymentDate,0,@ExtraCol,@PaymentID,@DOCUMENTTYPE,'Extra Amount Paid-Amendment',@UniqueID)     
		Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@PartyID)  
 End  
 ...
 Begin  
		Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
		[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
		Values(@DocumentID,@PartyID,@PaymentDate,@AdjAmt,0,@PaymentID,@DOCUMENTTYPE,'Adjusted with Shortage Paid-Amendment',@UniqueID)     
		Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@PartyID)  
		
		Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
		[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
		Values(@DocumentID,@DISCOUNT,@PaymentDate,0,@AdjAmt,@PaymentID,@DOCUMENTTYPE,'Adjusted with Shortage Paid-Amendment',@UniqueID)  
...
Begin  
 ...
 Begin  
  ...
  Begin  
    ...
    Set @Narration='Cash Payment-Amendment'  
  End   
 End  
 Else If @PaymentMode=1  
 Begin  
   ...
   Commit Tran  
		...
		Begin  
			...
			Begin  
				...
				Set @Narration='Current Date Cheque Payment-Amendment'  
			End  
  End  
		Else If @ChequeDate>@CurrentDate  
		Begin  
   ...
   Begin  
				...
				Set @Narration='Post Dated Cheque Payment-Amendment'  
			End  
		End  
 End  
 Else If @PaymentMode=2  
  ...
  Begin  
		  ...
		  Begin
		   ...
		   WHILE @@Fetch_Status=0
		    Begin
							Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
							[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
							Values(@DocumentID,@ExpenseAcID,@PaymentDate,@ExpenseValue,0,@PaymentID,@DOCUMENTTYPE,'Cash Payment-Amendment',@UniqueID)  
							Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseAcID)  
		 ...
		 Else
		  Begin
		   Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
		   [Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
		   Values(@DocumentID,@ExpenseID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Cash Payment-Amendment',@UniqueID)    
		   Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseID)  
				End    
			...
			Begin  
			  ...
			  Begin
			   ...
			   WHILE @@Fetch_Status=0
			    Begin
								Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
								[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
								Values(@DocumentID,@ExpenseAcID,@PaymentDate,@ExpenseValue,0,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
								Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseAcID)  
			 ...
			 Else
			  Begin
						Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
						[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
						Values(@DocumentID,@ExpenseID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Post Dated Cheque Payment-Amendment',@UniqueID)  
						Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseID)  
					End
			End  
			If @Value<>0  
			...
			Begin  
			  ...
			  Begin
			   ...
			   WHILE @@Fetch_Status=0
			    Begin
								Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
								[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
								Values(@DocumentID,@ExpenseAcID,@PaymentDate,@ExpenseValue,0,@PaymentID,@DOCUMENTTYPE,'Current Date Cheque Payment-Amendment',@UniqueID)  
								Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseAcID)  
			 ...
			 Else
			  Begin
						Insert GeneralJournal ([TransactionID],[AccountID],[TransactionDate],  
						[Debit],[Credit],[DocumentReference],[DocumentType],[Remarks],[DocumentNumber])  
						Values(@DocumentID,@ExpenseID,@PaymentDate,@Value,0,@PaymentID,@DOCUMENTTYPE,'Current Date Cheque Payment-Amendment',@UniqueID)  
						Insert INTO #TempBackDatedOtherPayment(AccountID) Values(@ExpenseID)  
					End
