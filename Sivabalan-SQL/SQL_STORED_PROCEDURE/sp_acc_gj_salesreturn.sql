CREATE Procedure sp_acc_gj_salesreturn(@INVOICEID INT,@BackDate DATETIME=Null)    
AS    
...
-- Execute sp_acc_insertGJ @TransactionID,@AccountID2,@InvoiceDate,@TotalSalesTax,0,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
-- Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID2)    
--End    
If @TotalTaxSuffered<>0    
Begin    
 -- Entry for Tax suffered account    
 Execute sp_acc_insertGJ @TransactionID,@AccountID5,@InvoiceDate,@TotalTaxSuffered,0,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
...
--GST_Changes starts
 ...
 begin		
	...
	begin
		...
		begin
			...
			begin
				...
				begin
					execute sp_acc_insertGJ @TransactionID,@gst_payable,@InvoiceDate,@nGSTaxAmt,0,@InvoiceID,@AccountType,"Sales Return",@DocumentNumber                
	...
	begin
		...
		begin 
			execute sp_acc_insertGJ @TransactionID,@gst_payable,@InvoiceDate,@nVatTaxamount,0,@InvoiceID,@AccountType,"VAT Sales Return",@DocumentNumber                
			Insert Into #TempBackdatedAccounts(AccountID) Values(@gst_payable)
		end	
	end   	
 end
...
Begin  
  ...
  Execute sp_acc_insertGJ @TransactionID,@VAT_Payable,@InvoiceDate,@nVatTaxamount,0,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
...
Begin    
 -- Entry for Sales tax account    
 Execute sp_acc_insertGJ @TransactionID,@AccountID6,@InvoiceDate,@Freight,0,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
 Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID6)    
End    
If @SalesValue<>0    
Begin    
 -- Entry for Sales account    
 Execute sp_acc_insertGJ @TransactionID,@AccountID3,@InvoiceDate,@SalesValue,0,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
 Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID3)    
End    
If @NetValue<>0    
Begin    
 -- Entry for customer account    
 Execute sp_acc_insertGJ @TransactionID,@AccountID,@InvoiceDate,0,@NetValue,@INVOICEID,@AccountType,"Sales Return",@DocumentNumber    
...
Begin    
 ...
 Execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,@RoundOffAmount,0,@INVOICEID,@AccountType,"Sales Return - RoundOff Amount",@DocumentNumber    
 -- Entry for Customer Account    
 Execute sp_acc_insertGJ @TransactionID,@AccountID,@InvoiceDate,0,@RoundOffAmount,@INVOICEID,@AccountType,"Sales Return - RoundOff Amount",@DocumentNumber    
...
Begin    
 ...
 Commit Tran    
 -- Entry for Customer Account    
 execute sp_acc_insertGJ @TransactionID,@AccountID,@InvoiceDate,@RoundOffAmount,0,@InvoiceID,@AccountType,"Sales Return - RoundOff Amount",@DocumentNumber    
 -- Entry for RoundOff Account    
 execute sp_acc_insertGJ @TransactionID,@RoundOffAccount,@InvoiceDate,0,@RoundOffAmount,@InvoiceID,@AccountType,"Sales Return - RoundOff Amount",@DocumentNumber    
 Insert Into #TempBackdatedAccounts(AccountID) Values(@AccountID)    
 Insert Into #TempBackdatedAccounts(AccountID) Values(@RoundOffAccount)    
End    
-------------------------------------Entry for Schemes----------------------------------------  
