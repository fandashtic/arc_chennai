CREATE procedure [dbo].[spr_RetailSales_by_Category_abstract](              
...
Select Cast(InvoiceAbstract.InvoiceID as nvarchar) + ';' + @Category ,"Invoice ID" =  @Voucher + Cast(DocumentID as nvarchar), InvoiceDate, Doctor.Name as "Referred By",Customer.Company_Name     
...
Select Cast(InvoiceAbstract.InvoiceID as nvarchar) + ';' + @Category ,"Invoice ID" =  @Voucher + Cast(DocumentID as nvarchar), InvoiceDate,NULL, Customer.Company_Name               
