...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_UT_CG](@INVNO INT)     
AS     
Set dateformat DMY     
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_UT_CG @INVNO,1
...
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' then 'Sale Invoice' Else 
	'Sale Invoice' End From Customer cu Where cu.CustomerID = Customer.CustomerID),
