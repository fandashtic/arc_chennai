Create Procedure [dbo].Spr_QuotationMargin(@ProductHierarchy Nvarchar(255), @Category Nvarchar(4000),@ItemCode Nvarchar(4000),@UOM Nvarchar(4000),@FromDate DateTime,@ToDate DateTime)
As
Begin
Set DateFormat DMY
...
Select Tmp.InvoiceID, Tmp.QuotationID, Tmp.CustomerID, Tmp.Product_Code, Sum(Tmp.Quantity),
...
Select [Detail Info],@WDCode [WDCode],@WDDest [WDDest],@FromDate [From Date], @ToDate [To Date], [Item Code],[Item Name],[UOM],
