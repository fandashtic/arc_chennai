...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_NG_DOS_Punjab](@INVNO INT)     
AS    
Set dateformat DMY      
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_Punjab @INVNO,1
...
"Disclaimer" = Case when IsNull(Customer.TIN_Number, '') = '' then ''  
Else                
'a. Original copy "Input Tax Credit is available to a person against this copy"                 ' + 
'b. Second copy "This copy does not entitle the holder to claim Input Tax Credit"               ' + 
'c. Last copy shall be retained by the seller'
End,
