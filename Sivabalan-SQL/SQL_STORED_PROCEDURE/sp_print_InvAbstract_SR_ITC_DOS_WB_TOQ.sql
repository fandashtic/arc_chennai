...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_WB_TOQ](@INVNO INT)     
AS       
Set dateformat DMY   
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_WB_TOQ @INVNO,1
...
"TaxDetailsWithBreakup" = Replace(dbo.GetTaxDetailsWithBreakup_DOS_TOQ (@INVNO),';',Char(13)), 
"TaxDetails" = Replace(dbo.GetTaxDetails_DOS_TOQ (@INVNO),';',Char(13)), 
...
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' Then 'Tax Invoice' Else 
