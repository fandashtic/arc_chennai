CREATE PROCEDURE spr_list_items_in_SalesReturn_Chevron(@INVOICEID int,@UOMDesc nvarchar(30))          
AS          
...
"Gross Amount"=SUM(InvoiceDetail.Quantity) * ISNULL(InvoiceDetail.SalePrice, 0),
"Volume" = (    
