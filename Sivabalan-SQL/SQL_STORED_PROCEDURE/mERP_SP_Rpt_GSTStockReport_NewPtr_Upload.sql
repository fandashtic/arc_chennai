create Procedure mERP_SP_Rpt_GSTStockReport_NewPtr_Upload(@Date nVarchar(25))
AS
BEGIN
SET DATEFORMAT DMY
...
/*2 is for Division*/
Exec Sp_GetCGLeafCat_ITC @CategoryGroup, @ProductHierarchy, 'CG'   
...
Update Reports_To_Upload set Frequency = 0 where ReportDataID = 1459         
...
select Batch_Code,PTR from Batch_Products


Select #tempCategory1.[IDs],@WDCode as "WDCode", @WDDest as "WD Dest", Items.Product_code as [Item Code],
Items.ProductName as [Item Name],#temp4.Parent as [Category],UOM.Description as [UOM],isnull(batch_products_PTRUpdateCG1.Batch_Number,'') as [Batch],
isnull(batch_products_PTRUpdateCG1.PTS,0) as [Net PTS Excl Tax],isnull(batch_products_PTRUpdateCG1.PTR,0) as [PTR Excl Tax],
isnull(batch_products_PTRUpdateCG1.MRPPerPack,0) as [MRP Per Pack],batch_products_PTRUpdateCG1.TaxSuffered AS 'Purchase Tax Rate',
...
From Items, ItemCategories, #temp4, Manufacturer, #tempCategory1, #tmpMfr, #tempItems,Uom,batch_products_PTRUpdateCG1,#Temp_Batch_Products_new
Where                                  
...
And batch_products_PTRUpdateCG1.Product_code = Items.Product_Code
AND #Temp_Batch_Products_new.Batch_Code=batch_products_PTRUpdateCG1.Batch_Code
/*Quantity should be greater than zero and Non-Damage Stock*/
And isnull(Quantity,0)>0
--And isnull(Damage,0)=0

Group by Items.Product_code,Items.ProductName,#temp4.Parent,UOM.Description,batch_products_PTRUpdateCG1.Batch_Number,
batch_products_PTRUpdateCG1.PTS,batch_products_PTRUpdateCG1.PTR,batch_products_PTRUpdateCG1.MRPPerPack,
batch_products_PTRUpdateCG1.TaxSuffered,#tempCategory1.[IDs],#Temp_Batch_Products_new.PTR_new,
batch_products_PTRUpdateCG1.TaxType,batch_products_PTRUpdateCG1.TOQ,batch_products_PTRUpdateCG1.Damage,Items.HSNNumber
