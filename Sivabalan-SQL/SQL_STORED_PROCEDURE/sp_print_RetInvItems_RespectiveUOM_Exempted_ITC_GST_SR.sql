...
Create Procedure [dbo].[sp_print_RetInvItems_RespectiveUOM_Exempted_ITC_GST_SR](@INVNO INT,@MODE INT=0)
AS
Begin
...
Else 0
End) as decimal(18,2))
Else cast((case when @utgst_flag = 1 then sum(UTGSTAmt) Else Max(SGSTAmt) End) as decimal(18,2))
End as nVarchar),''),
