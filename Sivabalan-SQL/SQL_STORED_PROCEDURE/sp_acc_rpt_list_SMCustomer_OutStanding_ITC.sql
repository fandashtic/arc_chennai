--Exec sp_acc_rpt_list_SMCustomer_OutStanding_ITC '%','%','2019-04-04 00:00:00','2019-04-04 23:59:59'
create procedure sp_acc_rpt_list_SMCustomer_OutStanding_ITC(  @Beat nVarchar(2550),   
...
BEGIN  
 ...
 select Cast(#temp.SalesmanID as nVarchar) + N';' + Cast(#temp.BeatID as nVarchar),  
  ...
  "DsType" = dbo.fn_Get_DSTypeBySalesManId(#temp.SalesmanID),  
