Create procedure sp_acc_rpt_list_SMCGICustomer_OutStanding_ITC(  
...
Create table #tmpSalesMan(SalesManId nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS)      
Create table #tmpCategoryGroup(GroupId nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS)      
...
Begin  
   ...
   Insert into #tmpCategoryGroup Select GroupId from Productcategorygroupabstract  
End  
Else      
...
----------------------------------  
 ...
 Select Cast(#temp.SalesmanID as nVarchar) + N';' + Cast(#temp.BeatID as nVarchar)+ N';' + Cast(#temp.GroupID as nVarchar),    
