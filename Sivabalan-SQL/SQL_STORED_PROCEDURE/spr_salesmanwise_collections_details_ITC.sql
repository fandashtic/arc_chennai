CREATE procedure spr_salesmanwise_collections_details_ITC (@smanid integer,@FROMDATE datetime, @TODATE datetime)        
as        
...
ChequeNo nvarchar(400)  COLLATE SQL_Latin1_General_CP1_CI_AS,        
Chequedate DateTime,        
AccountNumber nvarchar(200)  COLLATE SQL_Latin1_General_CP1_CI_AS,
...
Collectionid, Docnetvalue, totadj, Extracol, CollWriteoff, invadj, pDiscount, DisAmt, Doctype, ColDiscount, ColDiscAmt)        
...
"Collection Writeoff"=(Select dbo.fn_GetWriteOff(CollectionDetail.CollectionID)),            
