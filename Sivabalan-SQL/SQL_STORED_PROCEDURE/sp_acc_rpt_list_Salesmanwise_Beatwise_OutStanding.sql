CREATE procedure [dbo].[sp_acc_rpt_list_Salesmanwise_Beatwise_OutStanding](@Beat nVarchar(2550),      
...
Begin    
 ...
 SELECT  IsNull(CreditNote.SalesmanID,0),       
  IsNull((select Beat_Salesman.BeatID 
  From Beat_Salesman 
 ...
 IsNull((Select Beat.Description From Beat_Salesman Left Outer Join Beat on Beat_Salesman.BeatID = Beat.BeatID Where   
 CustomerID = CreditNote.CustomerID), N'%') In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
 ...
 IsNull((Select Beat.Description From Beat_Salesman Left Outer Join Beat on Beat_Salesman.BeatID = Beat.BeatID Where CustomerID = DebitNote.CustomerID), N'%') 
 In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
...
insert into #temp      
 ...
 DocumentDate Between @FromDate AND @ToDate AND      
 CreditNote.CustomerID IS NOT NULL And       
 IsNull((Select Beat.Description From Beat_Salesman, Beat Where Beat_Salesman.BeatID = Beat.BeatID And CustomerID = CreditNote.CustomerID), N'%') In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
 --IsNull(CreditNote.SalesmanID, 0) *= Salesman.SalesmanID And      
 Salesman.Salesman_Name In (Select SalesManName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpSalesMan)      
 ...
 DocumentDate Between @FromDate AND @ToDate AND      
 DebitNote.CustomerID IS NOT NULL And       
 IsNull((Select Beat.Description From Beat_Salesman, Beat Where Beat_Salesman.BeatID = Beat.BeatID And CustomerID = DebitNote.CustomerID), N'%') In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
 --IsNull(DebitNote.SalesmanID, 0) *= Salesman.SalesmanID And      
 Salesman.Salesman_Name In (Select SalesManName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpSalesMan)      
...
insert into #temp      
 ...
 DocumentDate Between @FromDate AND @ToDate AND      
 CreditNote.CustomerID IS NOT NULL And       
 IsNull((Select Beat.Description From Beat_Salesman Left Outer Join Beat on Beat_Salesman.BeatID = Beat.BeatID  Where CustomerID = CreditNote.CustomerID), N'%') In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
 IsNull(CreditNote.SalesmanID, 0) = Salesman.SalesmanID And      
 Salesman.Salesman_Name In (Select SalesManName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpSalesMan)      
 ...
 DocumentDate Between @FromDate AND @ToDate AND      
 DebitNote.CustomerID IS NOT NULL And       
 IsNull((Select Beat.Description From Beat_Salesman Left Outer Join Beat on Beat_Salesman.BeatID = Beat.BeatID Where CustomerID = DebitNote.CustomerID), N'%') In (Select BeatName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpBeat) And      
 IsNull(DebitNote.SalesmanID, 0) = Salesman.SalesmanID And      
 Salesman.Salesman_Name In (Select SalesManName COLLATE SQL_Latin1_General_CP1_CI_AS from #tmpSalesMan)      
