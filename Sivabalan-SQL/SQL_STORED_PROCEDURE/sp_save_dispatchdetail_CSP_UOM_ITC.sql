...
Create Procedure sp_save_dispatchdetail_CSP_UOM_ITC(@DISPATCH_ID int,      
...
BEGIN      
 ...
 FlagWord, UOM, UOMQty, UOMPrice, Serial, OtherCG_Item,SchemeID,FreeSerial,CSchemeid,  
 SPLCATSCHEMEID,SpecialCategoryScheme,SPLCATSerial,MultipleSchemeID,MultipleSchemeDetails,
 MultipleSplcatschemeid,MULTIPLESPLCATEGORYsCHDETAIL)      
 VALUES (@DISPATCH_ID, @ITEM_CODE, 0, @REQUIRED_QUANTITY, @SALE_PRICE, @FLAG,      
 @UOMID, @UOMQty, @UOMPrice, @serial, @OtherCG_Item,@SchemeID,@freeSerial,@CSchemeID,  
 @SPLCATSCHEMEID,@SpecialCategoryScheme,@SPLCATSerial,@MultiSchID,@MultiSchemeDetail,
 @MultiCatSchID, @MultiCatSchemeDetail )      
...
IF @TRACK_BATCHES = 1      
 ...
 IF @CUSTOMER_TYPE = 1      
  ...
  AND ISNULL(PTS, 0) = @SALE_PRICE AND (Expiry >= GetDate() OR Expiry IS NULL)       
...
BEGIN      
 ...
 SalePrice, FlagWord, UOM, UOMQty, UOMPrice, serial, OtherCG_Item,SchemeID,freeSerial,CSchemeID,  
 SPLCATSCHEMEID,SpecialCategoryScheme,SPLCATSerial,MultipleSchemeID,MultipleSchemeDetails,
 MultipleSplcatschemeid,MULTIPLESPLCATEGORYsCHDETAIL)     
 VALUES (@DISPATCH_ID, @ITEM_CODE, @BATCH_CODE, @REQUIRED_QUANTITY, @SALE_PRICE,       
 @FLAG, @UOMID, @UOMQTy, @UOMPrice, @Serial, @OtherCG_Item,@SchemeID,@freeSerial,@CSchemeID,  
 @SPLCATSCHEMEID,@SpecialCategoryScheme,@SPLCATSerial,@MultiSchID,@MultiSchemeDetail,
 @MultiCatSchID, @MultiCatSchemeDetail )      
