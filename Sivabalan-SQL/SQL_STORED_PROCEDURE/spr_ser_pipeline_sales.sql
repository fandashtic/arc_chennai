CREATE PROCEDURE spr_ser_pipeline_sales(@PERIOD nVARCHAR(15))  
AS  
DECLARE @AGG INT  
...
CREATE TABLE  #PIPELINE (Product_Code nvarchar(15) COLLATE SQL_Latin1_General_CP1_CI_AS, Value Decimal(18,6))  
...
INSERT INTO #PIPELINE   
SELECT serviceInvoiceDetail.SpareCode, ServiceInvoiceDetail.NetValue   
