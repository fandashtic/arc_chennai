CREATE PROCEDURE spr_list_trading_margins_manufacturerwise(@FROMDATE DATETIME, @TODATE DATETIME)
AS
create table #temp(ManufacturerID int, ManufacturerName nvarchar(128) COLLATE SQL_Latin1_General_CP1_CI_AS, Margin Decimal(18,6))
insert into #temp
