...
CREATE Procedure [dbo].Spr_QuotationSales_Abstract_Tmp(@ProductHierarchy Nvarchar(255), @Category Nvarchar(4000),@ItemCode Nvarchar(4000),@UOM Nvarchar(4000),@FromDate DateTime,@ToDate DateTime)
As   
Begin
