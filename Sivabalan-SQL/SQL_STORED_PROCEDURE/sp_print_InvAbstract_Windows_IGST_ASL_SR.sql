Create Procedure [dbo].[sp_print_InvAbstract_Windows_IGST_ASL_SR](@INVNO INT)     
AS 
Set dateformat DMY         
...
Select @WDDL20 = DL20, @WDDL21 = DL21 From Setup
...
exec sp_print_RetInvItems_RespectiveUOM_MED_IGST_ITC_GST @INVNO,1
--Select  1
...
"InvoiceTotals" = 				  
				  ...
				  '|Net Amount           :' + Space(14-Len(cast(cast(isnull(Case InvoiceAbstract.InvoiceType When 4 Then  ((NetValue + RoundOffAmount) - (isnull(@AdjustedValue,0))) Else ((NetValue + RoundOffAmount) - (isnull(@AdjustedValue,0))) End ,0) as decimal(18,2)) as nvarchar(12)) + Char(13) + Char(10)))
