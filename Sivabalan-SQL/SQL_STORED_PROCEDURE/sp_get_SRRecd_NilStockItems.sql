CREATE Procedure sp_get_SRRecd_NilStockItems (@StockRequestNo int)    
As    
...
From Stock_Request_Detail_Received    
Where (IsNull(Product_Code, N'') = N'' Or   
Product_Code Not In (Select Distinct(Product_Code) From Batch_Products)) And    
