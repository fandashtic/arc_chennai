...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_NG_DOS_TN](@INVNO INT)     
AS    
Set dateformat DMY      
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_TN @INVNO,1
--Select  1
--From InvoiceDetail, Batch_Products,InvoiceAbstract  
--Where InvoiceDetail.InvoiceID in ( select invno from #temp1 )
...
if exists ( select invno from #temp1 where SRQty =-1 ) 
begin
