CREATE PROCEDURE spr_list_StkAdjReturnAbstract_MUOM(@VENDOR nvarchar(2550),  
            @FROMDATE datetime,  
...
"AdjustmentID" = Case ISNULL(GSTFlag,0) When 0 then AdjPrefix.Prefix + CAST(DocumentID AS nvarchar) ELSE ISNULL(AdjustmentReturnAbstract.GSTFullDocID,'') END,      
"Date" = AdjustmentDate,  
