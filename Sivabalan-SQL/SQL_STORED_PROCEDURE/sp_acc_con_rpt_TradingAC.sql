CREATE Procedure sp_acc_con_rpt_TradingAC(@FromDate DateTime, @Todate DateTime,@FormatType Int)
As
...
Begin
	Exec sp_acc_con_rpt_TradingACTShape @FromDate,@ToDate
End
If @FormatType=@VERTICALFORMAT
Begin
	Exec sp_acc_con_rpt_TradingACVertical @FromDate,@ToDate
End

Else IF @FormatType=@NORMALFORMAT OR @FormatType=@SPECIALFORMAT
Begin
