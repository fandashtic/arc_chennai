...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_NG_DOS_RJ](@INVNO INT)     
AS         
Set dateformat DMY 
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_NG_RJ @INVNO,1
...
--/*
--And 
--InvoiceDetail.Serial Not In(Select Id_free.Serial From InvoiceDetail Id_sale, InvoiceDetail Id_free 
--Where Id_sale.InvoiceID = Id_free.InvoiceID and Id_sale.InvoiceID = @INVNO and Id_sale.product_code = Id_free.product_code 
--and Id_sale.SalePrice <> 0 And Id_free.SalePrice = 0 And Id_sale.uom = Id_free.uom) 
--*/
--Group By 
----InvoiceDetail.Serial, 
--InvoiceDetail.Product_Code, InvoiceDetail.Batch_Number, InvoiceDetail.uom, 
--InvoiceDetail.SalePrice, 
----CAST(DATEPART(mm, Batch_Products.Expiry) AS nvarchar) + N'\' 
----+ SubString(CAST(DATEPART(yy, Batch_Products.Expiry) AS nvarchar), 3, 2), 
--InvoiceDetail.MRP, InvoiceDetail.SaleID,InvoiceAbstract.TaxOnMRP 
...
"Doc Ref" = InvoiceAbstract.DocReference + '/' + CASE InvoiceType WHEN 1 THEN Inv.Prefix WHEN 3 THEN InvA.Prefix WHEN 4 THEN SR.Prefix WHEN 5 THEN SR.Prefix END + CAST(DocumentID AS nvarchar),
...
"Net Value" = Case InvoiceAbstract.InvoiceType When 4 Then 0 - NetValue Else NetValue End, 
...
"TIN/NON TIN" = (Select Case IsNull(TIN_Number, '') When '' Then 'B i l l   o f   S a l e s' Else 
	'V a t   I n v o i c e' End From Customer cu Where cu.CustomerID = Customer.CustomerID), 
"HEADING" = 'I N V O I C E', 
"DISCLAIMER TEXT" = 'This is a second sale in the state of Rajasthan.',
