CREATE procedure sp_acc_get_Others_DebitNote(@DocumentID int)    
as    
...
Else ''    
end, Cancel_Memo,'Account'= dbo.getaccountname(isnull(DebitNote.AccountID,0)),DocumentReference,DocSerialType    
