...
CREATE procedure sp_ser_rpt_Estimationdetail (@EstimationID int)              
as              
...
Create table #JobEstimationDetail_Temp([_EstimationID] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS,[_Date of Sale] datetime null,[_Delivery Date] datetime null)

set @Iteminfo ='Alter table #JobEstimationDetail_Temp Add [_Item Code] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS,
[_Item Name] nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS, 
[' + @Itemspec1 + '] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS null, [' + @ItemSpec2 + '] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS null,
[' + @ItemSpec3 + '] nvarchar(50)COLLATE SQL_Latin1_General_CP1_CI_AS null,[' + @ItemSpec4 + '] nvarchar(50) COLLATE SQL_Latin1_General_CP1_CI_AS null,                                   
...
Insert into #JobEstimationDetail_Temp    
...
IIT.product_specification5 ,              
GM.[Description],
IIT.Soldby,EstDet.DeliveryTime,
IIT.Dateofsale,EstDet.DeliveryDate
...
[' + @Itemspec4 + '],[' + @Itemspec5 + '],[_Color] as "Color",
[_Date of Sale] as "Date of Sale",
[_Sold By] as "Sold By",
[_Delivery Date] as "Delivery Date",
[_Delivery Time] as "Delivery Time" from #JobEstimationDetail_Temp'   

Exec sp_executesql @ItemInfo1

Drop Table #JobEstimationDetail_Temp    
