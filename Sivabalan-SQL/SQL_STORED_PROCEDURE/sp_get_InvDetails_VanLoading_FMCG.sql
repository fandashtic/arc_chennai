CREATE PROCEDURE [dbo].[sp_get_InvDetails_VanLoading_FMCG](@CustomerID NVARCHAR(15), @Inv_No INT)        
AS        
...
Right Join Batch_Products BP on BP.Batch_Code = VSD.Batch_Code


WHERE InvDt.InvoiceID = @Inv_No 
--AND Items.Product_Code = InvDt.Product_Code    
--AND Items.CategoryID *= ItemCategories.CategoryID AND BP.Batch_Code =* VSD.Batch_Code  and
