Create Procedure mERP_spr_DSPerformance_Upload
(
...
--Changes in Total: and Max Points Total: Rows
Declare @DSTypeName nvarchar(255)
Declare @PMCode nVarchar(255)
Declare @PMDesc nVarchar(255)
...
[ParamID] [int] NULL,
[WDCode] [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[WDDest] [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[From Date] [datetime] NULL,
[To Date] [datetime] NULL,
[DSID] [int] NULL,
[DSName] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[DS Type] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Performance Metrics Code] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Description] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Category Group] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Parameter] [nvarchar](50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Overall or Focus] [nvarchar](500) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Frequency] [nvarchar](25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Target] [decimal](18, 6) NULL,
[Average Till Date] [decimal](18, 6) NULL,
[Till date Actual] [decimal](18, 6) NULL,
[Max Points] [decimal](18, 6) NULL,
[Till Date Points Earned] [decimal](18, 6) NULL,
[Generation Date] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Last Transaction Date] [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
TargetType nVarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS, ID int,
ProposedTargetValue Decimal (18,6), UpdatedTargetDate [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)

Create Table #tempXMLDetail (Id Int,
Product_Code [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
Product_Name [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
PMProductName [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
LevelOfProduct [nvarchar](510) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)

Create Table #XMLData(i int identity(1,1),XMLStr nVarchar(max) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)

Declare @SQLXML  Nvarchar(Max)
Declare @tmpParamID  Int
Declare @XMLWDCode  [nvarchar](510)
Declare @XMLWDDest  [nvarchar](510)
Declare @XMLFromDate  [nvarchar](510)
Declare @XMLToDate  [nvarchar](510)
Declare @XMLDSID  [nvarchar](510)
Declare @XMLDSName  [nvarchar](510)
Declare @XMLDSType  [nvarchar](510)
Declare @XMLPerformanceMetricsCode  [nvarchar](510)
Declare @XMLDescription  [nvarchar](510)
Declare @XMLCategoryGroup  [nvarchar](510)
Declare @XMLParameter  [nvarchar](510)
Declare @XMLOverallorFocus  [nvarchar](510)
Declare @XMLFrequency  [nvarchar](510)
Declare @XMLTarget  [nvarchar](510)
Declare @XMLAverageTillDate  [nvarchar](510)
Declare @XMLTodaysActual  [nvarchar](510)
Declare @XMLMaxPoints  [nvarchar](510)
Declare @XMLPointsEarnedToday  [nvarchar](510)
Declare @XMLGenerationDate  [nvarchar](510)
Declare @XMLLastTransactionDate  [nvarchar](510)
Declare @XMLProduct_Code  [nvarchar](510)
Declare @XMLProduct_Name  [nvarchar](510)
Declare @XMLPMProductName  [nvarchar](510)
Declare @XMLLevelOfProduct  [nvarchar](510)
Declare @XMLTilldateActual  [nvarchar](510)
Declare @XMLTillDatePointsEarned  [nvarchar](510)
Declare @XMLTargetType  [nvarchar](510)
Declare @XMLProposedTargetValue [nvarchar](510)
Declare @XMLUpdateTargetDate [nvarchar](510)

Declare @Product_Code  [nvarchar](510)
Declare @Product_Name  [nvarchar](510)
Declare @PMProductName  [nvarchar](510)
Declare @LevelOfProduct  [nvarchar](510)
...
Flag int, CPM_Param int,TargetParameterType int,ProposedTargetValue Decimal (18,6), UpdatedTargetDate Datetime, DependDaysWorked Integer)
...
[Last Transaction Date] nVarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS, Flag int,TargetParameterType int,
TargetType nVarchar(100) COLLATE SQL_Latin1_General_CP1_CI_AS,ProposedTargetValue Decimal (18,6), UpdatedTargetDate [nvarchar](100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL)
...
Create table #tDSTgtZeroInv (TGT_PMID Int, TGT_DSTYPEID Int, TGT_PARAMID Int, TGT_SMID int, TGT_TARGETVAL Decimal(18,6),
TGT_MAXPOINT Decimal(18,6), TGT_FREQUENCY Int, TGT_ISFOCUSPARAM nVarchar(500) COLLATE SQL_Latin1_General_CP1_CI_AS,
TGT_PARAMMAX Decimal(18,6), TGT_PARAMTYPE Int, ProposedTargetValue Decimal (18,6), UpdatedTargetDate Datetime)
...
If @UptoWeek =  N'Week 1'
Begin
--If ((Select dbo.StripTimeFromDate(LastInventoryUpload) From Setup) >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 7,  @FromDate))))))

If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'GGDR Final Data') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 7,  @FromDate))))))
Select @DayClosed = 1
End
Else If @UptoWeek =  N'Week 2'
Begin
--If ((Select dbo.StripTimeFromDate(LastInventoryUpload) From Setup) >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 14,  @FromDate))))))
If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'GGDR Final Data') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 14,  @FromDate))))))
Select @DayClosed = 1
End
Else If @UptoWeek =  N'Week 3'
Begin
--If ((Select dbo.StripTimeFromDate(LastInventoryUpload) From Setup) >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 21,  @FromDate))))))
If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'GGDR Final Data') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 21,  @FromDate))))))
Select @DayClosed = 1
End
Else If @UptoWeek =  N'Week 4'
Begin
--If ((Select dbo.StripTimeFromDate(LastInventoryUpload) From Setup) >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(MM, +1,  @DtMonth))))))
If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'GGDR Final Data') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(MM, +1,  @DtMonth))))))
Select @DayClosed = 1
End
End
Else If @ReportType = N'Daily'
...
If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'GGDR Final Data') >= dbo.StripTimeFromDate(@RptDate))
Select @DayClosed = 1
End
End

-- To check Gate DayClose
Declare @DayClosed_Gate int
Select @DayClosed_Gate = 0
IF (Select isNull(Flag,0) From tbl_mERP_ConfigAbstract Where ScreenCode = 'CLSDAY01') = 1
Begin
IF @ReportType = N'Monthly'
Begin
IF @UptoWeek =  N'Week 1'
Begin
IF ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 7,  @FromDate))))))
and ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB Monthly') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 7,  @FromDate))))))
Select @DayClosed_Gate = 1
End
Else IF @UptoWeek =  N'Week 2'
Begin
IF ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 14,  @FromDate))))))
and ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB Monthly') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 14,  @FromDate))))))
Select @DayClosed_Gate = 1
End
Else IF @UptoWeek =  N'Week 3'
Begin
IF ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 21,  @FromDate))))))
and ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB Monthly') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(DD, 21,  @FromDate))))))
Select @DayClosed_Gate = 1
End
Else IF @UptoWeek =  N'Week 4'
Begin
IF ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(MM, +1,  @DtMonth))))))
and ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB Monthly') >= dbo.StripTimeFromDate((Select DATEADD(s,-1,(DateAdd(MM, +1,  @DtMonth))))))
Select @DayClosed_Gate = 1
End
End
Else IF @ReportType = N'Daily'
Begin
IF ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB') >= dbo.StripTimeFromDate(@RptDate))
and ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'PM GateUOB Monthly') >= dbo.StripTimeFromDate(@RptDate))
Select @DayClosed_Gate = 1
End
End
...
/* To Check Day Close for TLC and NOA */
...
--If ((Select Top 1 dbo.StripTimeFromDate(DayCloseDate) From DayCloseModules Where Module = 'Total Lines Cut') >= dbo.StripTimeFromDate(@LastDate_TLCNOA))
...
If @DayClosed = 0 or @DayClosed_Gate = 0
GoTo OvernOut
...
--	Insert Into #tmpInvoice
--	Select   IA.InvoiceID,IA.InvoiceDate,SM.SalesmanID,Ide.Product_Code,IC.Category_Name, IC1.Category_Name,
--			 IC2.Category_Name,IC3.Category_Name,CGDiv.GroupName,isNull(Ide.Amount,0),IA.InvoiceType,
--			 IA.InvoiceDate,isNull(IA.DSTypeID,0)
--	From
--		InvoiceAbstract IA,InvoiceDetail Ide,dbo.fn_getOCGSKU('%') I
--		,ItemCategories IC,ItemCategories IC1,
--		ItemCategories IC2,ItemCategories IC3,
--		ProductCategoryGroupabstract CGDiv,Salesman SM
--	Where
--		( IsNull(IA.Status,0) & 128 = 0)
--		And dbo.StripTimeFromDate(IA.InvoiceDate) Between @MonthFirstDate And @TillDate
--		And IA.InvoiceType in(1,3,4)
...
--		And IC1.ParentID = IC2.CategoryID
--		And IC2.ParentID = IC3.CategoryID
--		And I.GroupId = CGDiv.GroupID
--		And IA.SalesmanID = SM.SalesmanID
--		And isnull(CGDiv.OCGType,0)=1
--	End
...
If @OCG=0
Begin
Update T1 set T1.CurrentdsType = T.CNT From #DSPMSalesman T1, (select Distinct Salesmanid, DSTypeValue CNT From DSType_Master TM,DSType_Details DD Where DD.DSTypeID = TM.DSTypeid And DD.DSTypectlpos =1
--And isnull(TM.OCGType,0)=0
) T
...
And ((Param.ParameterType not in(6,7,13) and  isnull(Param.TargetParameterType,0) = 0)
or (Param.ParameterType in(10)))
--AND isnull(DSMast.Active,0)=1
--AND isnull(DSMast.OCGType,0)=1
END
...
Declare @ProposedTargetValue Decimal(18,6)
Declare @TargetUpdateDate Datetime
...
@Target  =0,@MaxPoints=0,@TodaysActual=0,@TillDateActualSales = 0,
@TodaysActualSales = 0,@DSTypeID=0, @GatePercentage = 0, @GateFlag = 0, @GateUOB_Target =  0,
@GateUOB_Slab = 0, @GateUOB_AbsoluteTarget = 0, @ComparisonType = 0, @GateUOB_GrowthTarget = 0,
@ProposedTargetValue = 0, @TargetUpdateDate = Null, @DependDaysWorked = 0

Select @GatePMID = PMID, @ParamType = ParameterType,@Frequency = Frequency , @isFocusParam  = isFocusParam,
@CGGroups = isNull(CGGroups,''),@SalesmanID = salesmanID,@Level = Prod_Level,
@ParamID = ParamID--,@FocusID = FocusID
,@DSTypeID = DSTypeCode, @GateDSTypeID = DSTypeID, @TargetParameterType = isnull(TargetParameterType,0) From #tmpPM Where RowID = @Counter
...
Begin -- /* The Target is not Defined then also the Sales value is displayed in the Report */ : DSPM Report Changes
--				If (Select Count(TargetDefnID) From tbl_mERP_PMetric_TargetDefn Where ParamID = @ParamID And FocusID = @FocusID
--				And isNull(Target,0) > 0 And isNull(MaxPoints,0) > 0 And Active = 1 And SalesmanID = @SalesmanID And DSTypeID = @DSTypeID) >=1
...
Begin
Select @Target = isNull(Target,0), @MaxPoints = case When Target > 0 Then isNull(MaxPoints,0) Else 0 End,
@ProposedTargetValue = isnull(ProposedTargetValue,0),
@TargetUpdateDate = Case When isnull(ModifiedDate,'') = '' Then TargetDefnDate Else ModifiedDate End
From tbl_mERP_PMetric_TargetDefn
...
LastTranDate = @LastInvoiceDate, ProposedTargetValue = @ProposedTargetValue,
UpdatedTargetDate = @TargetUpdateDate
Where RowID = @Counter
Else If @ReportType = 'Daily'
/* When Parameter Frequency is Monthly And the Report generated for daily then Todays points cannot be calculated */
...
Begin
Select @Target = isNull(Target,0), @MaxPoints = isNull(MaxPoints,0),
@ProposedTargetValue = isnull(ProposedTargetValue,0),
@TargetUpdateDate = Case When ModifiedDate is null Then TargetDefnDate Else ModifiedDate End
From tbl_mERP_PMetric_TargetDefn
Where ParamID = @ParamID --And FocusID = @FocusID
And Active = 1 --And Target > 0
And SalesmanID =@SalesmanID
...
AverageTillDate = Cast(@TillDateActualSales as decimal(18,6))/@NoOfDaysInvoiced , Target = @Target ,
MaxPoints = @MaxPoints,
GenerationDate = @RptGenerationDate,
LastTranDate = @LastInvoiceDate, ProposedTargetValue = @ProposedTargetValue,
UpdatedTargetDate = @TargetUpdateDate
Where RowID = @Counter
...
Set @ProposedTargetValue = isnull(@Target,0)
Select @TargetUpdateDate = isnull(CreationDate,'') From tbl_mERP_PMMaster Where PMID = @GatePMID
...
AverageTillDate = Cast(@TillDateActualSales as decimal(18,6))/@NoOfDaysInvoiced , Target = @Target ,
MaxPoints = @MaxPoints,
GenerationDate = @RptGenerationDate,LastTranDate = @LastInvoiceDate,ProposedTargetValue = @ProposedTargetValue,
UpdatedTargetDate = @TargetUpdateDate
Where RowID = @Counter
...
Select Distinct PMID, PMDSTYPEID, PARAMID
From tbl_merp_PMetric_TargetDefn
Where Active = 1 And PMID in (Select Distinct PMID From #tmpPM)
Open Cur_TgtPMLst
Fetch next From Cur_TgtPMLst into @TGTPMID, @TGTDSTYPEID, @TGTPARAMID
While @@Fetch_Status = 0
Begin
Insert into #tDSTgtZeroInv(TGT_PMID, TGT_DSTYPEID, TGT_PARAMID, TGT_SMID, TGT_TARGETVAL, TGT_MAXPOINT, TGT_FREQUENCY, TGT_ISFOCUSPARAM, TGT_PARAMTYPE, TGT_PARAMMAX, ProposedTargetValue, UpdatedTargetDate)
Select Tdf.PMID, Tdf.PMDSTYPEID, Tdf.PARAMID, Tdf.SALESMANID, Tdf.TARGET, Tdf.MAXPOINTS, PMP.FREQUENCY,
(PMFocus.PMProductName),PMP.ParameterType, PMP.MaxPoints, isnull(TDF.ProposedTargetValue,0), Case When isnull(TDF.ModifiedDate,'') = '' Then TDF.TargetDefnDate Else TDF.ModifiedDate End
...
/* To insert TLC for Salesman having Target with nil Invoices */
Declare Cur_TgtPMLst Cursor For
...
/* To insert NOA for Salesman having Target with nil Invoices */
Declare Cur_TgtPMLst Cursor For
...
--When 12 Then (Case @DayClosed_TLCNOA When 0 Then 0 When 1 Then (Case When (Frequency = 2 And @ReportType = 'Daily') Then 0 Else Cast(isNull(TillDatePointsEarned,0) as decimal(18,6)) End) End)
...
Case ParameterType When 6 Then Null When 7 Then Null Else AverageTillDate End [Average Till Date],
...
When 2 Then (Case When @ReportType = 'Monthly' Then (Case When isNull(MaxPoints,0) > 0 and isNull(TillDatePointsEarned,0) > isNull(MaxPoints,0) Then Cast(isNull(MaxPoints,0) as Decimal(18,6)) Else Cast(isNull(TillDatePointsEarned,0) as Decimal(18,6)) End)
Else Cast(isNull(TillDatePointsEarned,0) as Decimal(18,6)) End)
--When 12 Then (Case @DayClosed_TLCNOA When 0 Then NULL When 1 Then (Case When (Frequency = 2 And @ReportType = 'Daily') Then NULL Else Cast(isNull(TillDatePointsEarned,0) as decimal(18,6)) End) End)
When 12 Then (Case @DayClosed_TLCNOA When 0 Then 0 When 1 Then (Case When (Frequency = 2 And @ReportType = 'Daily') Then 0 Else
(Case When isNull(MaxPoints,0) > 0 and isNull(TillDatePointsEarned,0) > isNull(MaxPoints,0) Then Cast(isNull(MaxPoints,0) as Decimal(18,6)) Else Cast(isNull(TillDatePointsEarned,0) as Decimal(18,6)) End) End) End)
...
ProposedTargetValue, Convert(nVarchar(10),UpdatedTargetDate,103) + N' ' + Convert(nVarchar(8),UpdatedTargetDate,108) [UpdatedTargetDate]
Into #TempVal
...
[Last Transaction Date], [Flag],TargetParameterType,TargetType, ProposedTargetValue, UpdatedTargetDate)
...
ProposedTargetValue, UpdatedTargetDate)
...
isnull(tDStgt.ProposedTargetValue,0),
Convert(nVarchar(10),tDStgt.UpdatedTargetDate,103) + N' ' + Convert(nVarchar(8),tDStgt.UpdatedTargetDate,108)
...
A.ProposedTargetValue = B.ProposedTargetValue,
A.UpdatedTargetDate = B.UpdatedTargetDate
...
Update #tmpOutput Set [Max Points] = 0 Where isnull(Target,0) = 0 And  [Parameter] <> 'Max Points Total:' and Parameter Not in('Lines Cut', 'Bills Cut', 'Total Bills Cut', 'Blockbuster', 'UOB', 'Winner SKU')
...
Insert Into #tmpOutput([WDCode],[WDDest],DSName,[DS Type],[Performance Metrics Code],Description,[Category Group],
[From Date],[To Date],[Parameter],[Max Points],[Till Date Points Earned],[Last Transaction Date],[Generation Date])
Select Top 1 [WDCode],[WDDest],DSName,[DS Type],[Performance Metrics Code],Description,[Category Group],[From Date],[To Date]
,@MAXPOINT_TOTAL,Case IsNull(@MaxPoints,0) When 0 Then (Select IsNull(Max(MaxPoints),0) From tbl_mERP_PMDSType Where DsTypeID=@PMDSTypeID) Else @MaxPoints End,
(Case When @TillDatePointsEarned > @MaxPoints Then @MaxPoints Else @TillDatePointsEarned End),Convert(nVarchar(10),@LastInvoiceDate,103) + N' ' + Convert(nVarchar(8),@LastInvoiceDate,108),Convert(nVarchar(10),@RptGenerationDate,103) + N' ' + Convert(nVarchar(8),@RptGenerationDate,108) From #TempVal
Else If @ReportType = 'Daily'
...
Select Top 1 [WDCode],[WDDest],DSName,[DS Type],[Performance Metrics Code],Description,[Category Group],[From Date],[To Date]
,@MAXPOINT_TOTAL,Case IsNull(@MaxPoints,0) When 0 Then (Select IsNull(Max(MaxPoints),0) From tbl_mERP_PMDSType Where DsTypeID=@PMDSTypeID) Else @MaxPoints End,
(Case When @ToDaysPointsEarned > @MaxPoints Then @MaxPoints Else @ToDaysPointsEarned End),Convert(nVarchar(10),@LastInvoiceDate,103) + N' ' + Convert(nVarchar(8),@LastInvoiceDate,108),Convert(nVarchar(10),@RptGenerationDate,103) + N' ' + Convert(nVarchar(8),@RptGenerationDate,108) From #TempVal
End
...
Insert Into #tmpOutput([WDCode],[WDDest],[From Date],[To Date],[Last Transaction Date],[Generation Date],[Parameter],[Till Date Points Earned])
Select @WDCode ,@WDDest,@FromDate,@ToDate,Convert(nVarchar(10),@LastInvoiceDate,103) + N' ' + Convert(nVarchar(8),@LastInvoiceDate,108),Convert(nVarchar(10),@RptGenerationDate,103) + N' ' + Convert(nVarchar(8),@RptGenerationDate,108),@GRNTOTAL,Sum(Cast(isNull([Till Date Points Earned],0) as decimal(18,6))) From #tmpOutput Where [Parameter] = @MAXPOINT_TOTAL
Else If @ReportType = 'Daily'
...
Insert Into #tmpOutput([WDCode],[WDDest],[From Date],[To Date],[Last Transaction Date],[Generation Date],[Parameter],[Points Earned Today])
Select @WDCode ,@WDDest,@FromDate,@ToDate,Convert(nVarchar(10),@LastInvoiceDate,103) + N' ' + Convert(nVarchar(8),@LastInvoiceDate,108),Convert(nVarchar(10),@RptGenerationDate,103) + N' ' + Convert(nVarchar(8),@RptGenerationDate,108),@GRNTOTAL,Sum(Cast(isNull([Points Earned Today],0) as Decimal(18,6))) From #tmpOutput Where [Parameter] = @MAXPOINT_TOTAL
End
...
If @ReportType = 'Monthly'
Begin
Truncate Table #TmpAbstract
Insert Into #TmpAbstract
Select ParamID,[WDCode],[WDDest],[From Date],dbo.StripTimeFromDate([To Date])[To Date],DSID, DSName ,[DS Type],[Performance Metrics Code],Description,[Category Group],
Parameter,[Overall or Focus],Frequency,Target,[Average Till Date],[Till date Actual],[Max Points],
[Till Date Points Earned],[Generation Date],[Last Transaction Date],isnull(TargetType,'') as TargetType, ID, ProposedTargetValue, UpdatedTargetDate
...
Insert Into #TmpAbstract
Select ParamID,[WDCode],[WDDest],[From Date],dbo.StripTimeFromDate([To Date])[To Date],DSID,DSName ,[DS Type],[Performance Metrics Code],Description,[Category Group],
Parameter,[Overall or Focus],Frequency,Target,[Average Till Date],[Todays Actual],[Max Points],
[Points Earned Today],[Generation Date],[Last Transaction Date],isnull(TargetType,'') as TargetType, ID, ProposedTargetValue, UpdatedTargetDate
From #tmpOutput Order By [ID]
End

Declare @ID int

Declare cluParam Cursor For
select * from #TmpAbstract Order By ID

--where isnull(Parameter,'') <> 'Max Points Total:' and isnull(Parameter,'') <> 'Total:' and isnull(dsname,'') <> ''
--	select ParamID,[WDCode],[WDDest],Convert(Nvarchar(10),[From Date],103),Convert(Nvarchar(10),[To Date],103),DSID,DSName ,[DS Type],[Performance Metrics Code],Description,[Category Group],
--		Parameter,[Overall or Focus],Frequency,Target,[Average Till Date],[Todays Actual],[Max Points],
--		[Points Earned Today],[Generation Date],[Last Transaction Date] from #tmpOutput
Open cluParam
Fetch from cluParam into @tmpParamID,@XMLWDCode,@XMLWDDest,@XMLFromDate,@XMLToDate,@XMLDSID,@XMLDSName,@XMLDSType,@XMLPerformanceMetricsCode,@XMLDescription,@XMLCategoryGroup,@XMLParameter,@XMLOverallorFocus,@XMLFrequency,@XMLTarget,@XMLAverageTillDate,@XMLTilldateActual,@XMLMaxPoints,@XMLTillDatePointsEarned,@XMLGenerationDate,@XMLLastTransactionDate,@XMLTargetType,@ID,@XMLProposedTargetValue,@XMLUpdateTargetDate
While (@@fetch_status <>-1)
Begin
--Abstract xml
Set @SQLXML = ''
Set @SQLXML =  'Abstract _1="'+ cast( Isnull(@XMLWDCode,'') as Nvarchar(255)) +
'" _2="'+ cast( Isnull(@XMLWDDest,'')  as Nvarchar(255)) +
'" _3 ="' + cast( Isnull(@XMLFromDate,'')  as Nvarchar(255)) +
'" _4 ="' + cast( Isnull(@XMLToDate,'')  as Nvarchar(255)) +
'" _5 ="' + cast( Isnull(@XMLDSID ,'') as Nvarchar(255)) +
'" _6 ="' + cast( Isnull(@XMLDSName,'')  as Nvarchar(255)) +
'" _7 ="' + cast( Isnull(@XMLDSType ,'') as Nvarchar(255)) +
'" _8 ="' + cast( Isnull(@XMLPerformanceMetricsCode ,'') as Nvarchar(255)) +
'" _9 ="' + cast( Isnull(@XMLDescription ,'') as Nvarchar(255)) +
'" _10 ="' + cast( Isnull(@XMLCategoryGroup ,'') as Nvarchar(255)) +
'" _11 ="' + cast( Isnull(@XMLParameter ,'') as Nvarchar(255)) +
'" _12 ="' + cast( Isnull(@XMLOverallorFocus ,'') as Nvarchar(500)) +
'" _13 ="' + cast( Isnull(@XMLFrequency ,0) as Nvarchar(255)) +
'" _14 ="' + cast( Isnull(@XMLProposedTargetValue,0) as Nvarchar(255)) +
'" _15 ="' + cast( Isnull(@XMLTarget ,0) as Nvarchar(255)) +
'" _16 ="' + cast( Isnull(@XMLAverageTillDate ,0) as Nvarchar(255)) +
'" _17 ="' + cast( Isnull(@XMLTilldateActual,0)  as Nvarchar(255)) +
'" _18 ="' + cast( Isnull(@XMLMaxPoints ,0) as Nvarchar(255)) +
'" _19 ="' + cast( Isnull(@XMLTillDatePointsEarned ,0) as Nvarchar(255)) +
'" _20 ="' + cast( Isnull(@XMLUpdateTargetDate,'')  as Nvarchar(255)) +
'" _21 ="' + cast( Isnull(@XMLGenerationDate  ,'')as Nvarchar(255)) +
'" _22 ="' + cast( Isnull(@XMLLastTransactionDate,'')  as Nvarchar(255)) +
'" _23 ="' + cast( Isnull(@XMLTargetType,'')  as Nvarchar(255)) + '"'

Insert Into #XMLData(xmlstr)  Select @SQLXML
--Detail part
Truncate table #tempXMLDetail
if (isnull(@tmpParamid,'') <> '')
Begin
Insert into #tempXMLDetail (Id,Product_Code,Product_Name,PMProductName,LevelOfProduct)
Exec Sp_GetPMCategoryList @tmpParamID

If Exists(select * from #tempXMLDetail) --And @XMLDSName<>'' and @XMLParameter  <> 'Max Points Total:' and @XMLParameter <> 'Total:'
Begin
Declare cluXML Cursor For
Select Product_Code,Product_Name,PMProductName,LevelOfProduct From #tempXMLDetail
Open cluXML
Fetch from cluXML into @Product_Code,@Product_Name,@PMProductName,@LevelOfProduct
While (@@fetch_status <>-1)
Begin
Set @SQLXML = ''
Set @SQLXML = 'Detail _24="' + cast( Isnull(@Product_Code ,'') as Nvarchar(255)) +
'" _25 ="' + cast( Isnull(@Product_Name ,'') as Nvarchar(255))+
'" _26 ="' +  cast( Isnull(@PMProductName ,'') as Nvarchar(500))+
'" _27 ="' + cast( Isnull(@LevelOfProduct ,'') as Nvarchar(255))+'"'

Insert Into #XMLData(xmlstr) select @SQLXML
Fetch Next from cluXML into @Product_Code,@Product_Name,@PMProductName,@LevelOfProduct
End
Close cluXML
Deallocate cluXML
...
--				Begin
--					Set @SQLXML = ''
--					Set @SQLXML = 'Detail _21="' + cast('' as nvarchar(2)) +
--								  '" _22 ="' + cast('' as nvarchar(2)) +
--								  '" _23 ="' + cast('' as nvarchar(2)) +
--								  '" _24 ="' + cast('' as nvarchar(2)) +
--								  '" _25 ="' + cast('' as nvarchar(2)) +'"'
--					Insert Into #XMLData select @SQLXML
--				end
--				If @XMLDSID=8
--				Select * from #tempXMLDetail
--				set @tmpParamID=''; set @XMLDSName ='';
Fetch Next from cluParam into @tmpParamID,@XMLWDCode,@XMLWDDest,@XMLFromDate,@XMLToDate,@XMLDSID,@XMLDSName,@XMLDSType,@XMLPerformanceMetricsCode,@XMLDescription,@XMLCategoryGroup,@XMLParameter,@XMLOverallorFocus,@XMLFrequency,@XMLTarget,@XMLAverageTillDate,@XMLTilldateActual,@XMLMaxPoints,@XMLTillDatePointsEarned,@XMLGenerationDate,@XMLLastTransactionDate,@XMLTargetType,@ID,@XMLProposedTargetValue,@XMLUpdateTargetDate
...
If @DayClosed = 1
Begin
Select Isnull(XMLStr,'Abstract') XMLStr from #XMLData as XMLData order by i For XML Auto , Root('Root')
--select * from #TmpAbstract Order By ID
End
