...
Create Procedure [dbo].[sp_print_InvAbstract_SR_ITC_DOS_CG_TL](@INVNO INT)     
AS     
Set Dateformat DMY     
...
exec sp_print_RetInvItems_RespectiveUOM_SR_ITC_TL @INVNO,1
--Select 1 
...
"Disclaimer" = 'This is a Second sale in the State of Telangana.',
