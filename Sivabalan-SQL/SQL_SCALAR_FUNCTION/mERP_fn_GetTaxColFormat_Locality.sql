...
Create Function mERP_fn_GetTaxColFormat_Locality(@TaxCode Int, @TaxCompCode Int, @Locality Int)  
...
Begin  
 ...
 Set @LTConst = 'VAT_'  
 Set @CTConst = 'CST_'  
-- Set @TaxCode = 10; Set @TaxCompCode = 4; Set @lstflag = 1;  
...
--    print '@RetStr - ' + @RetStr  
 ...
 Begin  
  ...
  From TaxComponents Where Tax_Code = @TaxCode And TaxComponent_Code = @TaxCompCode and LST_Flag  = @Locality  
  
  Set @RetStr = @RetStr + '_(' + @TaxComp + ')'  
--        print '@TaxComp - ' + @TaxComp     
