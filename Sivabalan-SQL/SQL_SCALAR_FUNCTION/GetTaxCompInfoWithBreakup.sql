Create Function GetTaxCompInfoWithBreakup (@InvNo int,@Product_Code nvarchar(255), @TaxID Int, @TaxAmount Decimal(18, 2)) 
...
Begin 
  ...
  Set @Result = IsNull(@Result, N'') + ' ' + Space(9 -len(@CompPercentage)) + @CompPercentage + Space(10 -len(@CompValue)) + @CompValue + Space(9 -len(@CompPercentage1)) + @CompPercentage1 + Space(10 -len(@CompValue1)) + @CompValue1 
