Create function dbo.merp_fn_Get_ProductMarginDetID(@Product_Code nvarchar(50),@GRNDate DateTime = Null)
Returns Int
As
Begin
...
End    
 ...
 End
  ...
  Select @ReturnValue = IsNull(ID,0) from @TmpMargin where ID=(select Top 1 ID from @TmpMargin  order by level desc, EDate Desc)
  Return @ReturnValue
End 
