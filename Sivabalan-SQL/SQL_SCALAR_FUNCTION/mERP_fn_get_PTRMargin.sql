CREATE Function mERP_fn_get_PTRMargin
(
...
Select @PTRMargin = IsNull(Percentage,0) from @TmpMargin where ID=(select Top 1 ID from @TmpMargin  order by level desc, EDate Desc)
