CREATE Function MERP_FN_GetCreditNoteDetails_Windows(@InvoiceID Int,@Type Int)
...
DECLARE @TmpAdj  Table(CreditNoteDesc nVarchar(25)  COLLATE SQL_Latin1_General_CP1_CI_AS
,[Value] nVarchar(20)  COLLATE SQL_Latin1_General_CP1_CI_AS
,[AdjValue] nVarchar(20)  COLLATE SQL_Latin1_General_CP1_CI_AS
,[Balance Value] nVarchar(20)  COLLATE SQL_Latin1_General_CP1_CI_AS )
...
If @Type = 1
Begin
Select  @Result = @Result + '|' + Cast(CreditNoteDesc as Nvarchar(20)) + Replicate(' ',35 - Len(Cast([CreditNoteDesc] As nVarchar)))  From  @TmpAdj
