Create VIEW  [V_Customer_Master_v8]  
([Customer_ID],[Customer_Name],[Channel_Type],[Customer_Category],[Sub_Channel],[Phone_Number],[Email],
	...
	,[Channel_type_code], [Outlet_type_code], [Loyalty_type_code]
)  
AS
...
,olc.Channel_Type_Code As Channel_type_code, olc.Outlet_Type_Code As Outlet_type_code, olc.SubOutlet_Type_Code As Loyalty_type_code
