CREATE Function  fn_han_Get_SchemeCust()  
...
---------------------------------------
 ...
 where isnull(TSSD.GroupID,0)<>0 and TSA.SchemeType <> 3
 Open TmpCursor    
...
------------------------------------------
			...
			--select @GroupId  = min(groupId) from tbl_mERP_SchemeChannel where SchemeID =@SchemeID 
