Create Function fn_GetItemsCat_ITC(@CatGroup nvarchar(2550),@Category nvarchar(2550))
...
Begin
	...
	begin
		...
		From @TempCGCatMapping As ProductCategoryGroupDetail Where GroupID In (Select GroupID From ProductCategoryGroupAbstract Where GroupName In(Select * from dbo.sp_SplitIn2Rows(@CatGroup,@Delimeter)))
	end
	else
	begin
		Insert into @tmp1 select CategoryID, 0   
