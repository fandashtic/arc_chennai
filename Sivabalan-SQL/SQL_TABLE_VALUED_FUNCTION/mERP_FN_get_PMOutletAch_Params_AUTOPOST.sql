Create Function mERP_FN_get_PMOutletAch_Params_AUTOPOST(@DSTypeID Int)  
...
insert into @Result
  ...
  Case ParamMas.ID When 6 Then Cast(ParamDet.MaxPoints as nVarchar(50)) Else '' End MaxPoints,
