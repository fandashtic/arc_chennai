Create Function mERP_fn_Get_CSProductScope(@SchemeID Int)
...
Begin   
  ...
  Else  
    Insert into @tbl_CSSKU  
    Select SKUCode, 5 from tbl_mERP_SchSKUCodeScope Where SchemeID = @SCHEMEID and ProductScopeID = @PrdtScopeID
  ...
  Begin   
    ...
    MSKU.SChemeID = @SCHEMEID And MSKU.ProductScopeID = @PrdtScopeID And 
    ICat.Active = 1 And Items.Active = 1 
  ...
  Begin  
    ...
    Where Lev3.Level = 3 And Lev4.Level=4 And
     ...
     Lev3.Active = 1 And Items.Active= 1 
  ...
  Begin  
    ...
    Where Lev3.Level = 3 And Lev4.Level=4 And Lev2.Level=2 And 
     ...
     Items.CategoryID = Lev4.CategoryId And
     Items.Active =1 And Lev2.Active =1 
