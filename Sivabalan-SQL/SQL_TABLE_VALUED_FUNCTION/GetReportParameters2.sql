CREATE Function GetReportParameters2(@REPORT nvarchar(250))  
RETURNS @Parameters Table(ParameterID int, Manufacturer nvarchar(255), FromDate datetime, ToDate datetime)  
AS  
BEGIN  
...
Begin  
 ...
 Update @Parameters Set Manufacturer = (Select ParameterValue From ReportParameters   
 Where ParameterID = @ParameterID and ParameterName = 'Manufacturer') Where ParameterID = @ParameterID  
