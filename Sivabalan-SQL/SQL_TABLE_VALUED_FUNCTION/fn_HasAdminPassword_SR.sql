create function dbo.fn_HasAdminPassword_SR(@Ordernumber nvarchar(200),@DocDate datetime,@InvUploadFlag int)
...
BEGIN
	...
	BEGIN
		...
		BEGIN
			Set @Error='SR-Return Number ' + @Ordernumber + ' -  Day is closed.You can do transaction only between '+cast(DateAdd(D, 1,@LastInventoryUpload) as nvarchar(25))+' and '+ cast(@GraceDate as nvarchar(25))
