Create function mERP_fn_Get_CSOutletScope_View(@SCHEMEID Int, @QPS Int=1,@SubGrpID Int = 0)
...
Begin
	...
	Select GroupID From tbl_mERP_SchemeOutlet Where QPS = @QPS And SchemeID = @SCHEMEID 
	And GroupID = (Select Case @SubGrpID When 0 Then GroupID Else @SubGrpID End) Group By GroupID
	Open CurCSGroup
